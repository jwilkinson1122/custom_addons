...
class product_template(models.Model):
    ...
    def return_selected_products(self):
        ...
        export_conf = safe_eval(Config.get_param("podiatry_management_export_option", "False"))
    ...
    def _return_mass_actions(self):
        ...
        mass_actions = safe_eval(Config.get_param("podiatry_management.ir_actions_server_ids", "[]"))
        self = self.with_context(lang=self.env.user.lang)
        res = []
    ...
    def return_eshop_categories_hierarchy(self):
        ...
        DUMMY method to be implemented in podiatry_management _website_sale
        """
        return []
