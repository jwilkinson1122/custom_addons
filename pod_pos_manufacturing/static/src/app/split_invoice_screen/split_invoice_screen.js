...
export class SplitInvoiceScreen extends Component {
    static template = "pod_pos_manufacturing.SplitInvoiceScreen";
    ...
    proceed() {
        ...
        if (!this._isFullPayOrder()) {
            ...
            // for the warehouse printer we assume that everything
            // has already been sent to the warehouse before splitting
            // the invoice. So we save all changes both for the old
            // order and for the new one. This is not entirely correct
            // but avoids flooding the warehouse with unnecessary orders.
...
registry.category("pos_screens").add("SplitInvoiceScreen", SplitInvoiceScreen);
