...
import * as TipScreen from "@pod_pos_manufacturing/../tests/tours/helpers/TipScreenTourMethods";
...
registry.category("web_tour.tours").add("PosResTipScreenTour", {
    ...
    steps: () =>
        [
            ...
            FloorScreen.orderCountSyncedInSectionIs("2", "1"),
            FloorScreen.clickSection("2"),
            ProductScreen.totalAmountIs("2.0"),
            ...
            FloorScreen.backToFloor(),
            FloorScreen.orderCountSyncedInSectionIs("2", "2"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            ...
            FloorScreen.backToFloor(),
            FloorScreen.orderCountSyncedInSectionIs("5", "4"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
