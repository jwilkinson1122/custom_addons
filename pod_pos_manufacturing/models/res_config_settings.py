...
class ResConfigSettings(models.TransientModel):
    ...
    pos_iface_printinvoice = fields.Boolean(compute='_compute_pos_module_pos_manufacturing', store=True, readonly=False)
    pos_iface_splitinvoice = fields.Boolean(compute='_compute_pos_module_pos_manufacturing', store=True, readonly=False)
    pos_set_tip_after_payment = fields.Boolean(compute='_compute_pos_set_tip_after_payment', store=True, readonly=False)
    pos_module_pos_manufacturing_booking = fields.Boolean(related="pos_config_id.module_pos_manufacturing_booking", readonly=False)
