...
class TestProductSupplierinfoForCustomerPrescription(TransactionCase):
    def setUp(self):
        super(TestProductSupplierinfoForCustomerPrescription, self).setUp()
    ...
    def test_pod_product_info_for_customer_prescription(self):
        ...
        self.assertEqual(
            ...
            "Error: Min qty was not passed to the prescription order line",
        )
    ...
    def test_pod_product_info_for_customer_prescription_template(self):
    ...
    def test_pod_product_info_for_customer_prescription_variant_wo_template(self):
        customerinfo = self._create_partnerinfo(
            "customer", self.customer, self.product_variant_2, empty_variant=True
        )
        so = self.env["prescription.order"].create(
