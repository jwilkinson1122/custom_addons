...
export class ViewPrescriptionOrderButton extends Component {
    static template = "pod_prescription_from_pos.ViewPrescriptionOrderButton";
    setup() {
        this.pos = usePos();
    }
    async onClick() {
...
// odoo.define('pod_prescription_from_pos.ViewPrescriptionOrderButton', function(require) {
//     'use strict';
