...
class pod_pos_theme_settings(models.Model):
    ...
    # pod_pod_default_view = fields.Selection([ ('list', 'List View'),('grid', 'Grid View'),], 'Product Display Type', default="list", required=True)
    ...
    def write(self, vals):
        ...
        for rec in self:
            ...
            URL = "/nwpl_pod_master/static/pod_pos_theme_responsive/static/src/overrides/pos_theme_variables.scss"
