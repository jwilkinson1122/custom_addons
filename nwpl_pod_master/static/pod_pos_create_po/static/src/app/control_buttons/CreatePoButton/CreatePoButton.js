  /** @odoo-module **/
    ...
    import { PodPOConfirmPopup } from "@nwpl_pod_master/static/pod_pos_create_po/app/Popups/pod_po_confirm_popup/pod_po_confirm_popup";
                ...
                if (orderlines.length != 0) {
                    try {
                        ...
                        if (Orders && Orders.length > 0) {
                            self.popup.add(PodPOConfirmPopup, {
    ...
    ProductScreen.addControlButton({
        ...
        condition: function () {
            return this.pos.config.pod_dispaly_purchase_btn
        },
    })
