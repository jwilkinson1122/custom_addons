...
patch(Orderline.prototype, {
    ...
    init_from_JSON(json) {
        ...
        this.is_has_option = json.is_has_option;
    ...
    export_as_JSON() {
        ...
        res['is_has_option'] = this.is_has_option;
        res['pod_is_has_option'] = this.is_has_option;
        res['is_option'] = this.is_option || false;
        res['pod_is_option'] = this.is_option || false;
        return res
    },
    get_is_has_option() {
        return this.is_has_option
    },
    set_is_has_option(is_has_option) {
        this.is_has_option = is_has_option
    },
    export_for_printing() {
        let result = super.export_for_printing(...arguments);
        result['is_has_option'] = this.is_has_option || false;
...
patch(Order.prototype, {
    ...
    async add_option_product(product, options) {
        ...
        SelectedOrderline.set_is_has_option(true)
