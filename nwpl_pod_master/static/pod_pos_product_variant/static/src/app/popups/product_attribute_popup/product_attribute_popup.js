...
import { VariantProductItem } from "@nwpl_pod_master/static/pod_pos_product_variant/app/VariantProductItem/VariantProductItem";
import { usePos } from "@point_of_sale/app/store/pos_hook";


export class ProductAttributePopup extends AbstractAwaitablePopup {
    static components = { VariantProductItem };
    static template = "nwpl_pod_master.ProductAttributePopup";
    setup() {
        super.setup();
