...
import * as ProductScreenSale from "@pos_prescription/../tests/helpers/ProductScreenTourMethods";
...
registry.category("web_tour.tours").add("PosSettleOrderIncompatiblePartner", {
    ...
    steps: () =>
        [
            ProductScreen.confirmOpeningPopup(),
            ProductScreen.clickQuotationButton(),
            // The second item in the list is the first prescription.order.
            ProductScreen.selectNthOrder(2),
            ProductScreen.selectedOrderlineHas("product1", 1),
            ProductScreen.totalAmountIs("10.00"),

            ProductScreen.clickQuotationButton(),
            // The first item in the list is the second prescription.order.
            // Selecting the 2nd prescription.order should use a new order,
