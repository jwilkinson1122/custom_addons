...
class TestPoSSaleReport(TestPoSCommon):
    ...
    def test_different_shipping_address(self):
        ...
        data['data']['lines'][0][2]['prescription_order_origin_id'] = prescription_order.read()[0]
        data['data']['lines'][0][2]['prescription_order_line_id'] = prescription_order.order_line[0].read()[0]
