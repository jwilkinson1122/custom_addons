...
class PrescriptionCancel(models.TransientModel):
    _name = 'prescription.cancel'
    ...
    order_id = fields.Many2one('prescription', string="Prescription Order", required=True, ondelete='cascade')
