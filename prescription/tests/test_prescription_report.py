...
class TestPrescriptionReportCurrencyRate(PrescriptionCommon):
    ...
    def test_prescription_report_foreign_currency(self):
        ...
        prescriptions = self.env['prescription']
        ...
        for company in companies:
            Prescription = self.env['prescription'].with_company(company)
        ...
        ).search([('order_reference', 'in', [f'prescription,{so_id}' for so_id in prescriptions.ids])])
