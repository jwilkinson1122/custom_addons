...
class TestAccruedPrescriptions(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        # set 'type' to 'service' to allow manualy set 'qty_delivered' even with prescription_stock installed
        ...
        cls.prescription.analytic_account_id = cls.analytic_account_c
        ...
        cls.wizard = cls.env['account.accrued.orders.wizard'].with_context({
            ...
            'active_ids': cls.prescription.ids,
        }).create({
    ...
    def test_accrued_order(self):
        ...
        self.prescription_line.qty_delivered = 5
        ...
        invoices = self.prescription._create_invoices()
    ...
    def test_multi_currency_accrued_order(self):
        ...
        self.prescription_line.qty_delivered = 5
        # self.prescription_line.product_uom_qty = 5
        # set currency != company currency
        self.prescription.currency_id = self.currency_data['currency']
        self.assertRecordValues(self.env['account.move'].search(self.wizard.create_entries()['domain']).line_ids, [
            # reverse move lines
    ...
    def test_analytic_account_accrued_order(self):
        self.prescription_line.qty_delivered = 10
