...
class TestPrescriptionProductAttributeValueCommon(TestProductAttributeValueCommon):
...
class TestPrescriptionProductAttributeValueConfig(TestPrescriptionProductAttributeValueCommon):
    ...
    def test_01_is_combination_possible_archived(self):
        ...
        def do_test(self):
            ...
            so = self.env['prescription'].create({'partner_id': 1})
