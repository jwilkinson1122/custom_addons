...
from odoo.addons.prescription_team.tests.common import PrescriptionTeamCommon
...
class PrescriptionCommon(
    ...
    def setUpClass(cls):
        ...
        cls.empty_order = cls.env['prescription'].create({
            'partner_id': cls.partner.id,
        })
        cls.prescription = cls.env['prescription'].create({
            'partner_id': cls.partner.id,
            'order_line': [
                Command.create({
    ...
    def setup_prescription_configuration_for_company(cls, company):
        ...
        company_data = {
            ...
            'default_user_personnel': Users.create({
                ...
                'groups_id': [(6, 0, cls.env.ref('prescription_team.group_prescription_personnel').ids)],
