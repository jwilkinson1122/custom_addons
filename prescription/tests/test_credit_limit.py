...
class TestPrescriptionCreditLimit(TestPrescriptionCommon):
    ...
    def test_warning_on_invoice_with_downpayment(self):
        ...
        invoice = prescription.invoice_ids
        ...
        credit_note = prescription.invoice_ids[1]
        credit_note.action_post()

        # Check that the credit note is accounted for correctly for the amount_to_invoice
        self.assertEqual(prescription.amount_to_invoice, prescription.amount_total)
