odoo.define('prescription.PrescriptionModel', function (require) {
"use strict";

/**
 * This file defines the Model for the Prescription Kanban view, which is an
...
var PrescriptionModel = BasicModel.extend({
    init: function () {
