odoo.define('prescription.PrescriptionListRenderer', function (require) {
"use strict";

/**
 * This file defines the Renderer for the Prescription List view, which is an
 * override of the ListRenderer.
 */

var ListRenderer = require('web.ListRenderer');

var PrescriptionListRenderer = ListRenderer.extend({
     ...
     */
    start: function () {
        this.$el.addClass('o_prescription_view o_prescription_list_view');
...
return PrescriptionListRenderer;
