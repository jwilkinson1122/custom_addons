...
export class PrescriptionLineProductField extends Many2OneField {
    ...
    _editProductConfiguration() {} // prescription_product_configurator, prescription_product_matrix
}
...
registry.category("fields").add("rxl_product_many2one", prescriptionOrderLineProductField);
