...
registry.category("web_tour.tours").add("prescription_tour", {
    url: "/web",
    rainbowMan: false,
    sequence: 20,
    steps: () => [stepUtils.showAppsMenuItem(), {
    trigger: ".o_app[data-menu-xmlid='prescription.prescription_menu_root']",
...
}, stepUtils.showAppsMenuItem(),
{
    ...
    trigger: 'a.o_onboarding_step_action.btn[data-method=action_open_step_prescription_confirmation]',
    extra_trigger: ".o_prescription",
    content: _t("To speed up order confirmation, we can activate electronic signatures or payments."),
    position: "bottom",
    skip_trigger: 'a[data-method=action_open_step_prescription_confirmation].o_onboarding_step_action__done',
}, {
...
registry.category("web_tour.tours").add("prescription_quote_tour", {
        url: "/web#action=prescription.action_quotations_with_onboarding&view_type=form",
        rainbowMan: true,
