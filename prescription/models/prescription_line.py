...
class PrescriptionLine(models.Model):
    ...
    product_custom_attribute_value_ids = fields.Many2many(
        ...
        inverse_name='prescription_line_id',
    ...
    invoice_lines = fields.Many2many(
        ...
        relation='prescription_line_invoice_rel', column1='order_line_id', column2='invoice_line_id',
    ...
    def _compute_name(self):
        for line in self:
            ...
            name = line._get_prescription_line_multiline_description_prescription()
    ...
    def _get_prescription_line_multiline_description_prescription(self):
        ...
        """
        self.ensure_one()
        return self.product_id.get_product_multiline_description_prescription() + self._get_prescription_line_multiline_description_variants()
    ...
    def _compute_tax_id(self):
        ...
        lines_by_company = defaultdict(lambda: self.env['prescription.line'])
        cached_taxes = {}
        for line in self:
    ...
    # (cf prescription_stock) instead of simply removing the default and specifying
    # the compute attribute & method in prescription_stock.
    ...
    def _compute_qty_delivered_method(self):
        """ Prescription module compute delivered qty for product [('type', 'in', ['consu']), ('service_type', '=', 'manual')]
            ...
            This is true when only prescription is installed: prescription_stock redifine the behavior for 'consu' type,
    ...
    def _check_line_unlink(self):
        ...
        * Sections and Notes can always be deleted.
        ...
        :rtype: `prescription.line` recordset
        """
    ...
    def action_add_from_catalog(self):
        order = self.env['prescription'].browse(self.env.context.get('order_id'))
    ...
    def _get_product_catalog_lines_data(self, **kwargs):
        ...
        ``Prescription._is_readonly`` for more details) or if `self` contains multiple records.
