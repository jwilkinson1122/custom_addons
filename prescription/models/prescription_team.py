...
class PrescriptionTeam(models.Model):
    _name = "prescription.team"
    ...
    active = fields.Boolean(
        ...
        "to hide the Prescription Team without removing it.",
    )
    ...
    member_ids = fields.One2many(
        comodel_name="res.users",
        inverse_name="prescription_team_id",
        string="Team Members",
    )
    ...
    def _alias_get_creation_values(self):
        ...
        values["alias_model_id"] = self.env.ref("prescription.model_prescription").id
        if self.id:
