...

{
    ...
    'description': """
This module contains all the common features of Prescription Management and eCommerce.
    """,
    'depends': [
        'knowledge',
        'pos_sale',
    ...
    'data': [
        ...
        'wizard/prescription_discount_views.xml',
    ...
    'assets': {
        ...
        'web.report_assets_common': [
            'prescription/static/src/scss/prescription_report.scss',
        ],
    },
