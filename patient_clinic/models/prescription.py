...
class Prescription(models.Model):
    _name = 'patient_clinic.prescription'
    ...
    # Patient
    patient = fields.Many2one('patient_clinic.patient', required=True,
                              domain="[('owner', '=', owner)]")
    ...
    doctor = fields.Many2one(
        'patient_clinic.doctor', required=True, domain="[('item_service', '=', item_service)]")
