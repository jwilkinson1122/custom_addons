...
import { ModifierProductPopup } from "@pod_pos_product_modifier/js/ModifierProductPopup";
...
patch(ProductsWidget.prototype,{
    ...
    modifierSelection(event){
		...
		// 	if (leftRadio.value == "left foot"){
		// 		laterality = "Left Foot";
		// 	}else if(leftRadio.value == "right foot"){
