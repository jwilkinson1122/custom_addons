...
class Prescription(models.Model):
    ...
    def prescription_report(self):
        return self.env.ref('pod_dev.report_print_prescription').report_action(self)
    ...
    def print_prescription_report_ticket_size(self):
        return self.env.ref("pod_dev.practitioner_prescription_ticket_size2").report_action(self)

    # def print_prescription_report(self):
    #     return {
    #         'type': 'ir.actions.report',
    #         'report_name': "pod_dev.practitioner_prescription_template",
    #         'report_file': "pod_dev.practitioner_prescription_template",
    #         'report_type': 'qweb-pdf',
    #     }

    def print_podiatry_prescription_report_ticket_size(self):
        return self.env.ref("pod_dev.practitioner_prescription_podiatry_ticket_size2").report_action(self)
