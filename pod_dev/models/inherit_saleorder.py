...
class InheritedSaleOrder(models.Model):
    ...
    def print_prescription_report_ticket_size(self):
        return self.env.ref("pod_dev.practitioner_prescription_ticket_size2").report_action(self.prescription_id)

    def print_podiatry_prescription_report_ticket_size(self):
        return self.env.ref("pod_dev.practitioner_prescription_podiatry_ticket_size2").report_action(self.prescription_id)
    ...
    def print_sale_order_report(self):
        return {
            ...
            'report_name': "pod_dev.sale_order_report",
            'report_file': "pod_dev.sale_order_report",
    ...
    def print_prescription_report(self):
        return {
            'type': 'ir.actions.report',
            'report_name': "pod_dev.sale_prescription_template",
            'report_file': "pod_dev.sale_prescription_template",
            'report_type': 'qweb-pdf'
        }
    ...
    #     return {
    #         'type': 'ir.actions.report',
    #         'report_name': "pod_dev.purchase_order_report",
    #         'report_file': "pod_dev.purchase_order_report",
    #         'report_type': 'qweb-pdf',
    #     }

    # @api.onchange('prescription_id')
    # def test(self):
    #     product = self.env.ref('pod_dev.podiatry_product')
