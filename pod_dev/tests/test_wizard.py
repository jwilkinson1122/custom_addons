...
class ConfigurationWizard(ProductConfiguratorTestCases):
    def setUp(self):
        ...
        self.attr_line_fuel = self.env.ref(
            "pod_dev.product_attribute_line_2_series_fuel"
        )
        ...
        self.value_218d = self.env.ref(
            "pod_dev.product_attribute_value_218d"
        )
        self.value_220d = self.env.ref(
            "pod_dev.product_attribute_value_220d"
        )
        ...
        self.config_step_body = self.env.ref("pod_dev.config_step_body")
        ...
        self.cfg_tmpl = self.env.ref("pod_dev.bmw_2_series")
