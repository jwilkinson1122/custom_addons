...
class CustomPOS(models.Model):
	...
	pizza_pieces = fields.Boolean(string='Display Pizza Pieces?')
...
class POSSession(models.Model):
	...
	def _loader_params_product_product(self):
		...
		fields.extend(['product_template_attribute_value_ids','modifier_attribute_product_id','pizza_pieces','sub_products_ids'])
