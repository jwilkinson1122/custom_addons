...
export class ProductTemplatePopupWidget extends AbstractAwaitablePopup {
    static template = "bi_pos_modify_own_pizza.ProductTemplatePopupWidget";
    setup() {
        super.setup();
        this.pos = usePos();
    }
