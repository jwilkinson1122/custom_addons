...
import { ProductTemplatePopupWidget } from "@bi_pos_modify_own_pizza/js/ProductTemplatePopupWidget";
    ...
    async addProductToCurrentOrder(product, options = {}) {
		...
		if(self.config.product_configure){
            if (product.product_variant_count > 1) {
                ...
                this.env.services.pos.popup.add(ProductTemplatePopupWidget, {'variant_ids':prod_list,'product':product});
            } else {
