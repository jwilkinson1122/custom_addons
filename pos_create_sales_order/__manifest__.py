...
odoo Create Sales Order from Point of Sale Create SO from POS Create sales from Point of Sales
    ...
    """,
    "website": "https://www.browseinfo.com/demo-request?app=pos_create_sales_order&version=17&edition=Community",
    'live_test_url': 'https://www.browseinfo.com/demo-request?app=pos_create_sales_order&version=17&edition=Community',
    "data": [
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            'pos_create_sales_order/static/src/js/SaleCreatePopup.js',
            'pos_create_sales_order/static/src/js/SaleOrderPopup.js',
            'pos_create_sales_order/static/src/xml/**/*',
            'pos_create_sales_order/static/src/js/pos_store.js',
        ],
    },
    "auto_install": False,
    "installable": True,
