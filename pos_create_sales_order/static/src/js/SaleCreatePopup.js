...
import { SaleOrderPopup } from "@pos_create_sales_order/js/SaleOrderPopup";
import { Dialog } from "@web/core/dialog/dialog";
import { AlertDialog } from "@web/core/confirmation_dialog/confirmation_dialog";
import { useService } from "@web/core/utils/hooks";

export class SaleCreatePopup extends Component {
    static template = "pos_create_sales_order.SaleCreatePopup";
    ...
    create_order(){
        ...
        self.env.services.orm.call("pos.create.sales.order", "create_sales_order", [
