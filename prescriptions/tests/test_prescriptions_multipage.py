...
class TestMultipage(TransactionCase):
    ...
    def test_multipage_pdfs_prescriptions(self):
        ...
        self.assertTrue(prescription.is_multipage)

    def test_single_page_pdfs_prescriptions(self):
        prescription = self.env['prescriptions.prescription'].create({
        ...
        self.assertFalse(prescription.is_multipage)
