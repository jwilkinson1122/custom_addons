...
registry.category("web_tour.tours").add("prescriptions_tour", {
    url: "/web",
    rainbowManMessage: () =>
        markup(
            _t(
                "Wow... 6 prescriptions processed in a few seconds, You're good.<br/>The tour is complete. Try uploading your own prescriptions now."
            )
        ),
    sequence: 180,
    steps: () => [
        {
            ...
            content: markup(
                _t("Want to become a <b>paperless company</b>? Let's discover NWPL Prescriptions.")
            ),
            position: "bottom",
        },
        {
        ...
        },
        {
            ...
            content: markup(
                _t(
                    "Let's process prescriptions in your Inbox.<br/><i>Tip: Use Tags to filter prescriptions and structure your process.</i>"
                )
            ),
            position: "bottom",
            run: function (actions) {
        ...
        },
        {
            ...
            extra_trigger: "body:not(:has(.o_FileViewer)) .o_prescriptions_kanban",
        ...
        },
        {
            ...
            content: _t(
                "As this PDF contains multiple prescriptions, let's split and process in bulk."
            ),
            position: "bottom",
        },
        {
            ...
            content: markup(
                _t(
                    "Click on the <b>page separator</b>: we don't want to split these two pages as they belong to the same prescription."
                )
            ),
            position: "right",
        },
