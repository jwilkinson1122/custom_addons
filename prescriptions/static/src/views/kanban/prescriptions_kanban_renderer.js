...
import { PrescriptionsKanbanRecord } from "./prescriptions_kanban_record";
...
export class PrescriptionsKanbanRenderer extends KanbanRenderer {
    static props = [...KanbanRenderer.props, "inspectedPrescriptions", "previewStore"];
    static template = "prescriptions.PrescriptionsKanbanRenderer";
    static components = Object.assign({}, KanbanRenderer.components, {
        ...
        KanbanRecord: PrescriptionsKanbanRecord,
    ...
    focusNextCard(area, direction) {
        ...
        const focusedCardIdx = [...cards].indexOf(prescription.activeElement);
