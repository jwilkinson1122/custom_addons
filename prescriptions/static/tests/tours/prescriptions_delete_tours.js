...
function deleteWorspaceSteps() {
    return [
        ...
        },
        {
            ...
            run: async function () {
                const elements = prescription.querySelectorAll(".o_search_panel_label_title");
                ...
                await prescription
                    .querySelector("header.active .o_prescriptions_search_panel_section_edit")
                    .click();
            },
        },
        {
...
function restorePrescriptionSteps() {
    return [
        {
        ...
        },
        {
            ...
            content: "Select prescription",
        },
        {
            trigger: ".o_inspector_button.o_archived",
            content: "Restore the prescription",
        },
    ];
}

registry.category("web_tour.tours").add("prescription_delete_tour", {
    url: "/web",
    test: true,
    steps: () => [
        ...
        // 1) Archive a prescription and restore it in an active folder
        {
            trigger: '.o_search_panel_label_title:contains("Workspace1")',
            content: "Open workspace",
            run: "click",
        ...
        },
        {
            ...
            content: "Move prescription to trash",
        },
        {
        ...
        },
        {
            ...
            content: "Check that the prescription is no longer visible",
            isCheck: true,
        },
        ...restorePrescriptionSteps(),
        // 2) Archive a folder (and this its prescriptions) and restore the archived prescription
        ...deleteWorspaceSteps(),
        ...restorePrescriptionSteps(),
        // 3) Archive a folder (and this its prescriptions) and delete permanently the prescription
        ...deleteWorspaceSteps(),
        {
            trigger: '.o_search_panel_label_title:contains("Trash")',
            content: "Open trash",
        ...
        },
        {
            ...
            content: "Delete permanently the prescription",
        },
        {
            trigger: ".modal-footer .btn-primary",
            content: "Confirm deletion",
