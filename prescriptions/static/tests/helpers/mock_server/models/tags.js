...
patch(MockServer.prototype, {
    /**
     * Mocks the '_get_tags' method of the model 'prescriptions.tag'.
     */
    _mockPrescriptionsTag_GetTags(domain, folderId) {
        const facets = this.models['prescriptions.facet'].records;
        const orderedTags = this.models['prescriptions.tag'].records.sort((firstTag, secondTag) => {
        ...
        return orderedTags.map(tag => {
            const [facet] = this.mockSearchRead('prescriptions.facet', [[['id', '=', tag['facet_id']]]], {});
            return {
