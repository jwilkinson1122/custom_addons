...
import {
    createPrescriptionsView as originalCreatePrescriptionsView,
    createPrescriptionsViewWithMessaging,
    getEnrichedSearchArch,
} from "./prescriptions_test_utils";
...
function createPrescriptionsView(params) {
    return originalCreatePrescriptionsView({
    ...
    QUnit.module(
        "prescriptions_kanban_tests.js",
        {
            async beforeEach() {
                ...
                this.patchPrescriptionXHR = (mockedXHRs, customSend) => {
                ...
                const prescriptionsFolderIds = pyEnv["prescriptions.folder"].create([
                    {
                        name: "Workspace1",
                ...
                prescriptionsFolderIds.push(
                    pyEnv["prescriptions.folder"].create([
                        {
                            name: "Workspace3",
                            parent_folder_id: prescriptionsFolderIds[0],
                            has_write_access: true,
                        },
                    ])
                );
                const [prescriptionsFacetId1, prescriptionsFacetId2] = pyEnv["prescriptions.facet"].create([
                    { name: "Status", tooltip: "A Status tooltip", sequence: 11 },
                    { name: "Priority", tooltip: "A priority tooltip", sequence: 10 },
                ]);
                const prescriptionsTagIds = pyEnv["prescriptions.tag"].create([
                    { display_name: "New", facet_id: prescriptionsFacetId1, sequence: 11 },
                    { display_name: "Draft", facet_id: prescriptionsFacetId1, sequence: 10 },
                    { display_name: "No stress", facet_id: prescriptionsFacetId2, sequence: 10 },
                ]);
                const prescriptionsWorkflowRuleIds = pyEnv["prescriptions.workflow.rule"].create([
                    {
                ...
                const [prescriptionsPrescriptionId1, prescriptionsPrescriptionId2] = pyEnv[
                    "prescriptions.prescription"
                ].create([
                    {
                        activity_state: "today",
                        available_rule_ids: [
                            prescriptionsWorkflowRuleIds[0],
                            prescriptionsWorkflowRuleIds[1],
                            prescriptionsWorkflowRuleIds[3],
                        ],
                        file_size: 30000,
                        folder_id: prescriptionsFolderIds[0],
                        ...
                        tag_ids: [prescriptionsTagIds[0], prescriptionsTagIds[1]],
                    },
                    {
                        ...
                        tag_ids: [prescriptionsTagIds[1]],
                    },
                ]);
                pyEnv["prescriptions.prescription"].create([
                    {
                        available_rule_ids: prescriptionsWorkflowRuleIds,
                        file_size: 15000,
                        folder_id: prescriptionsFolderIds[0],
                        ...
                        owner_id: resUsersIds[1],
                        partner_id: resPartnerIds[0],
                        res_id: prescriptionsPrescriptionId2,
                        res_model: "prescriptions.prescription",
                        res_model_name: "Task",
                        tag_ids: [prescriptionsTagIds[0], prescriptionsTagIds[1], prescriptionsTagIds[2]],
                    },
                    {
                        file_size: 10000,
                        folder_id: prescriptionsFolderIds[0],
                    ...
                    },
                    {
                        ...
                        owner_id: resUsersIds[1],
                        partner_id: resPartnerIds[1],
                        tag_ids: prescriptionsTagIds,
                    },
                    {
                        file_size: 70000,
                        folder_id: prescriptionsFolderIds[1],
                        name: "pom",
                        partner_id: resPartnerIds[2],
                        res_id: prescriptionsPrescriptionId1,
                        res_model: "prescriptions.prescription",
                        res_model_name: "Prescription",
                    },
                    {
                        active: false,
                        file_size: 70000,
        ...
        function () {
            QUnit.test("kanban basic rendering", async function (assert) {
                assert.expect(25);
                await createPrescriptionsView({
                    type: "kanban",
                    resModel: "prescriptions.prescription",
                    arch: `<kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                    <div>
                ...
                assert.containsOnce(
                    ...
                    "> div.o_search_panel",
                    "should have a 'prescriptions selector' column"
                );
                assert.containsOnce(
                    target,
                ...
                assert.hasClass(
                    ...
                    "should have classname 'o_prescriptions_kanban_view'"
                );
                assert.containsN(
                    target,
                    ".o_kanban_renderer .o_kanban_record:not(.o_kanban_ghost)",
                ...
                assert.containsOnce(
                    target,
                    ".o_content > .o_prescriptions_inspector",
                    "should have a 'prescription inspector' column"
                );
                ...
                assert.containsN(
                    target,
                    ".o_cp_buttons button.o_prescriptions_kanban_url",
                    2,
                    "should allow to save a URL on small / xl screen"
                );
                assert.ok(
                    target.querySelector(".o_prescriptions_kanban_url").disabled === false,
                    "the upload url button should be enabled when a folder is selected"
                );
                assert.strictEqual(
                    target
                        .querySelector(".o_cp_buttons button.o_prescriptions_kanban_request")
                        .textContent.trim(),
                    "Request",
                    "should have a primary 'request' button"
                );
                assert.ok(
                    target.querySelector(".o_prescriptions_kanban_request").disabled === false,
                    "the request button should be enabled when a folder is selected"
                );
                assert.strictEqual(
                    target
                        .querySelector(
                            ".o_cp_buttons .dropdown-item.o_prescriptions_kanban_share_domain"
                        )
                        .textContent.trim(),
                    "Share",
            ...
            QUnit.test("can select records with keyboard navigation", async function (assert) {
                ...
                const kanban = await createPrescriptionsView({
                    type: "kanban",
                    resModel: "prescriptions.prescription",
                    arch: `<kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                        <div>
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.containsN(
                        target,
                        ".o_prescriptions_inspector_preview .o_prescription_preview",
                        3,
                        "should show 3 prescription previews in the PrescriptionsInspector"
                    );
                    ...
                    assert.containsOnce(
                        target,
                        ".o_prescriptions_inspector_preview .o_prescription_preview",
                        "should show 1 prescription preview in the PrescriptionsInspector"
                    );
                    ...
                    assert.containsOnce(
                        target,
                        ".o_prescriptions_inspector_preview .o_prescription_preview",
                        "should show 1 prescription previews in the PrescriptionsInspector"
                    );
                }
            );
                ...
                async function (assert) {
                    ...
                    patchWithCleanup(kanban.env.services.action, {
                        doActionButton(ev) {
                            ...
                            pyEnv["prescriptions.prescription"].write([ev.resId], { name: "yop changed" });
                            ev.onClose();
                        },
                    });
                    ...
                    assert.containsN(
                        ...
                        ".o_prescriptions_inspector_preview .o_prescription_preview",
                        3,
                        "should still show 3 prescription previews in the PrescriptionsInspector"
                    );
                }
            );
            ...
            QUnit.test("can share current domain", async function (assert) {
                ...
                // filter on 'task' in the PrescriptionsSelector
                ...
                await legacyClick($(".o_prescriptions_kanban_share_domain:visible").get(0));
            });
            ...
            QUnit.test("can upload from URL", async function (assert) {
                ...
                await legacyClick($(".o_cp_buttons .dropdown-toggle-split:visible").get(0));
                await legacyClick($(".o_prescriptions_kanban_url:visible").get(0));
            });
            ...
            QUnit.test("can Request a file", async function (assert) {
                ...
                patchWithCleanup(kanban.env.services.action, {
                    doAction(action) {
                        assert.deepEqual(
                            action,
                            "prescriptions.action_request_form",
                            "should open the url form"
                        );
                    },
                });
                ...
                await legacyClick($(".o_cp_buttons .dropdown-toggle-split:visible").get(0));
                await legacyClick($(".o_prescriptions_kanban_request:visible").get(0));
            });
            ...
            QUnit.test("can navigate with arrows", async function (assert) {
                ...
                const triggerKey = async (key) => {
                    await triggerEvent(prescription.activeElement, null, "keydown", {
                        key,
                    });
                };
                await triggerKey("ArrowRight");
                assert.strictEqual(
                    prescription.activeElement,
                    cards[1],
            ...
            QUnit.test("prescription inspector with no prescription selected", async function (assert) {
                assert.expect(3);
                ...
                assert.strictEqual(
                    target
                        .querySelector(".o_prescriptions_inspector_preview")
                ...
                assert.strictEqual(
                    ...
                    "5",
                    "should display the correct number of prescriptions"
                );
                assert.strictEqual(
            ...
            QUnit.test("prescription inspector with selected prescriptions", async function (assert) {
                assert.expect(5);
                ...
                assert.containsNone(
                    target,
                    ".o_prescriptions_inspector_info .o_selection_size",
                    "should not display the number of selected prescriptions (because only 1)"
                );
                assert.containsOnce(
                    target,
                    ".o_prescriptions_inspector_preview .o_prescription_preview",
                    "should show a preview of the selected prescription"
                );
                assert.hasClass(
                    target.querySelector(".o_prescriptions_inspector_preview .o_prescription_preview"),
                    "o_prescriptions_single_preview",
                    "should have the 'o_prescriptions_single_preview' className"
                );

                // select a second prescription
                await legacyClick(
                ...
                assert.strictEqual(
                    target
                        .querySelector(".o_prescriptions_inspector_preview .o_selection_size")
                        .textContent.trim(),
                    "2 prescriptions selected",
                    "should display the correct number of selected prescriptions"
                );
                assert.containsN(
                    target,
                    ".o_prescriptions_inspector_preview .o_prescription_preview",
                    2,
                    "should show a preview of the selected prescriptions"
                );
            });

            QUnit.test("prescription inspector limits preview to 4 prescriptions", async function (assert) {
                assert.expect(2);
                ...
                assert.containsN(
                    ...
                    ".o_prescriptions_inspector_preview .o_prescription_preview",
                    4,
                    "should only show a preview of 4 selected prescriptions"
                );
            });

            QUnit.test(
                "prescription inspector shows selected records of the current page",
                async function (assert) {
                    assert.expect(6);
                    ...
                    const kanban = await createPrescriptionsView({
                        type: "kanban",
                        resModel: "prescriptions.prescription",
                        arch: `<kanban js_class="prescriptions_kanban" limit="2"><templates><t t-name="kanban-box">
                    <div>
                        <field name="name"/>
                    </div>
                </t></templates></kanban>`,
                    ...
                    assert.containsNone(
                        target,
                        ".o_prescriptions_inspector_preview .o_prescription_preview",
                        "should show no prescription preview in the PrescriptionsInspector"
                    );
            ...
            QUnit.test("prescription inspector: prescription preview", async function (assert) {
                const views = {
                    "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                        <div>
                            <field name="name"/>
                        </div>
                    </t></templates></kanban>`,
                ...
                assert.containsNone(target, ".o_prescription_preview img");

                await legacyClick($(target).find(".o_kanban_record:contains(burp)")[0]);

                assert.containsNone(target, ".o-FileViewer", "should not have a prescription preview");
                assert.containsOnce(
                    target,
                    ".o_prescription_preview img",
                    "should have a clickable image"
                );

                await legacyClick(target, ".o_prescription_preview img");
                ...
                assert.containsOnce(
                    ...
                    `iframe[data-src="/web/static/lib/pdfjs/web/viewer.html?file=${encodeURIComponent(
                        getOrigin() + "/web/content/2?model=prescriptions.prescription"
                    )}#pagemode=none"]`,
            ...
            QUnit.test(
                "prescription inspector: open preview while modifying prescription",
                async function (assert) {
            ...
            QUnit.test("prescription inspector: can share records", async function (assert) {
                assert.expect(3);
                ...
                await legacyClick(
                    target.querySelector(".o_prescriptions_inspector_info .o_inspector_share")
                );
                await nextTick();
                assert.containsN(target, ".o_notification_body", 1, "should have a notification");
            });

            QUnit.test("prescription inspector: locked records", async function (assert) {
                assert.expect(6);
            ...
            QUnit.test("prescription inspector: can (un)lock records", async function (assert) {
                assert.expect(5);
                ...
                const kanban = await createPrescriptionsView({
                    ...
                    mockRPC: async (route, args, performRpc) => {
                        if (route === "/web/dataset/call_kw/prescriptions.prescription/toggle_lock") {
                            assert.deepEqual(
                                args.args,
                                [1],
            ...
            QUnit.test(
                "prescription inspector: prescription info with one prescription selected",
                async function (assert) {
                    assert.expect(6);
            ...
            QUnit.test(
                "prescription inspector: update prescription info with one prescription selected",
                async function (assert) {
                    assert.expect(7);
                    let count = 0;
            ...
            QUnit.test(
                "prescription inspector: prescription info with several prescriptions selected",
                async function (assert) {
                    assert.expect(7);
            ...
            QUnit.test(
                "prescription inspector: update prescription info with several prescriptions selected",
                async function (assert) {
                    assert.expect(10);
            ...
            QUnit.test(
                "prescription inspector: update info: handle concurrent updates",
                async function (assert) {
                    assert.expect(9);
                    ...
                    assert.strictEqual(
                        ...
                        "new name",
                        "should still display the new filename in the prescription inspector"
                    );
            ...
            QUnit.test("prescription inspector: open resource", async function (assert) {
                assert.expect(2);
                ...
                await legacyClick(
                    target.querySelector(".o_prescriptions_inspector .o_inspector_object_name")
                );
            });

            QUnit.test(
                "prescription inspector: display tags of selected prescriptions",
                async function (assert) {
                    assert.expect(4);
                    ...
                    assert.containsN(
                        ...
                        ".o_inspector_tag",
                        2,
                        "should display the tags of the selected prescription"
                    );
                    ...
                    assert.containsOnce(
                        target,
                        ".o_inspector_tag",
                        "should display the common tags between the two selected prescriptions"
                    );
                    assert.strictEqual(
            ...
            QUnit.test(
                "prescription inspector: input to add tags is hidden if no tag to add",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test("prescription inspector: remove tag", async function (assert) {
                assert.expect(4);
            ...
            QUnit.test("prescription inspector: add a tag [REQUIRE FOCUS]", async function (assert) {
                const [lastPrescriptionsTagId] = pyEnv["prescriptions.tag"].search([
                    ...
                    mockRPC: function (route, args) {
                        if (args.method === "write") {
                            ...
                            assert.deepEqual(
                                args.args[1],
                                {
                                    tag_ids: [[4, lastPrescriptionsTagId]],
                                },
                                "should write the correct value"
                            );
                        }
            ...
            QUnit.test(
                "prescription inspector: do not suggest already linked tags",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test(
                "prescription inspector: tags: trigger a search on input clicked",
                async function (assert) {
                    assert.expect(1);
            ...
            QUnit.test("prescription inspector: unknown tags are hidden", async function (assert) {
                assert.expect(1);

                const [firstPrescriptionRecord] = pyEnv["prescriptions.prescription"].searchRead([]);
                pyEnv["prescriptions.prescription"].write([firstPrescriptionRecord.id], {
                    tag_ids: [...firstPrescriptionRecord.tag_ids, 42],
                });
                await createPrescriptionsView({
                    type: "kanban",
                    resModel: "prescriptions.prescription",
            ...
            QUnit.test(
                "prescription inspector: display rules of selected prescriptions",
                async function (assert) {
                    assert.expect(6);
                    ...
                    assert.containsN(
                        ...
                        ".o_inspector_rule",
                        3,
                        "should display the rules of the selected prescription"
                    );
                    ...
                    assert.containsOnce(
                        target,
                        ".o_inspector_rule",
                        "should display the common rules between the two selected prescriptions"
                    );
                    assert.containsOnce(
                        target,
            ...
            QUnit.test(
                "prescription inspector: displays the right amount of single record rules",
                async function (assert) {
                    assert.expect(2);
                    ...
                    assert.containsN(
                        ...
                        ".o_inspector_rule",
                        3,
                        "should display the rules of the selected prescription (2 multi record, 1 single record)"
                    );
            ...
            QUnit.test("prescription inspector: locked by another user", async function (assert) {
                assert.expect(4);

                const resUsersId1 = pyEnv["res.users"].create({});
                pyEnv["prescriptions.prescription"].create({
                    folder_id: pyEnv["prescriptions.folder"].search([])[0],
            ...
            QUnit.test(
                "prescription inspector: display rules of reloaded record",
                async function (assert) {
                    assert.expect(9);
            ...
            QUnit.test(
                "prescription inspector: trigger rule actions on selected prescriptions",
                async function (assert) {
                    assert.expect(3);
                    ...
                    <div>
                        ...
                        mockRPC: async function (route, args) {
                            if (
                                args.model === "prescriptions.workflow.rule" &&
            ...
            QUnit.test(
                "prescription inspector: checks the buttons deleting/editing a link between a prescription and a record",
                async function (assert) {
                    assert.expect(6);
                    ...
                    // Prescription with an editable link.
                    await legacyClick(
                        target.querySelector(".o_search_panel_category_value:nth-of-type(2) header")
                    );
                    await legacyClick(target.querySelector(".o_kanban_record"));
                    ...
                    assert.containsOnce(
                        ...
                        "should display the edit button of the link between the prescription and the record on the inspector."
                    );
                    assert.containsOnce(
                        target,
                        ".o_inspector_model_button.o_inspector_model_delete",
                        "should display the delete button of the link between the prescription and the record on the inspector."
                    );
                    ...
                    assert.containsNone(
                        ...
                        "should display no records link to the prescription"
                    );

                    // Prescription with a non-editable link
                    await legacyClick(target.querySelector(".o_kanban_record"));
                    await legacyClick(
                        target.querySelector(".o_kanban_record:nth-of-type(2) .o_record_selector")
                    );
                    ...
                    assert.containsNone(
                        target,
                        "o_inspector_custom_field .o_model_container",
                        "should display a record link to the prescription"
                    );
                    assert.containsNone(
                        target,
                        ".o_inspector_model_button.o_inspector_model_edit",
                        "should not display the edit button of the link between the prescription and the record on the inspector."
                    );
                    assert.containsNone(
                        target,
                        ".o_inspector_model_button.o_inspector_model_delete",
                        "should not display the delete button of the link between the prescription and the record on the inspector."
                    );
                }
            );

            QUnit.test(
                "prescription inspector: quick create not enabled in dropdown",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test("prescription inspector: edit workspace", async function (assert) {
                assert.expect(6);
                pyEnv["prescriptions.folder"].create({
                    name: "Workspace5",
                    description: "_F1-test-description_",
                ...
                await legacyClick(
                    target,
                    ".o_prescriptions_inspector .o_field_widget[name=folder_id] input"
                );
                assert.containsN(
                    target,
                    ".o_prescriptions_inspector .o_field_widget[name=folder_id] .o-autocomplete li",
                    5
                );
                await legacyClick(
            ...
            QUnit.module("PrescriptionChatter");

            QUnit.test(
                "prescription inspector: download button on selecting the requested prescription",
                async function (assert) {
                    assert.expect(2);
                    ...
                    assert.ok(
                        ...
                        "the download button should be disabled when a requested prescription is selected"
                    );
                    ...
                    assert.ok(
                        ...
                        "the download button should be enabled when selecting requested prescription with another prescription"
                    );
                }
            );

            QUnit.test("prescription chatter: open and close chatter", async function (assert) {
                const views = {
                ...
                // open the chatter
                await click(".o_prescriptions_inspector .o_inspector_open_chatter");
                await contains(".o-mail-Chatter");
                assert.containsOnce(target, ".o_search_panel:visible");
                assert.containsOnce(target, ".o_kanban_renderer:visible");
                assert.containsOnce(target, ".o_prescriptions_inspector:visible");

                // close the chatter
                await click(".o-mail-Chatter-close");
                await contains(".o_prescription_chatter_container .o-mail-Chatter", { count: 0 });
            });

            QUnit.test(
                "prescription chatter: fetch and display chatter messages",
                async function (assert) {
                    const [prescriptionsPrescriptionId1] = pyEnv["prescriptions.prescription"].search([]);
                    ...
                    await legacyClick($(target).find(".o_kanban_record:contains(yop)")[0]);
                    await click(".o_prescriptions_inspector .o_inspector_open_chatter");
                    await contains(".o_prescription_chatter_container .o-mail-Chatter");
                    await contains(
                        ".o_prescription_chatter_container .o-mail-Chatter .o-mail-Message",
                        { count: 2 }
                    );
                }
            );

            QUnit.test("prescription chatter: fetch and display followers", async function (assert) {
                const [prescriptionsPrescriptionId1] = pyEnv["prescriptions.prescription"].search([]);
                ...
                await click(".o_prescriptions_inspector .o_inspector_open_chatter");
                await contains(".o_prescription_chatter_container .o-mail-Chatter");
                assert.containsOnce(target, ".o_prescription_chatter_container .o-mail-Followers");
                assert.strictEqual(
            ...
            QUnit.test("prescription chatter: render the activity button", async function (assert) {
                const views = {
                    "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban">
                    <templates>
                        <t t-name="kanban-box">
                ...
                const { env, openView } = await createPrescriptionsViewWithMessaging({
                    hasWebClient: true,
                    serverData: { views },
                });
                await openView({
                    ...
                    doAction(action) {
                        assert.deepEqual(action, {
                            context: {
                                active_id: 1,
                                active_ids: [1],
                                active_model: "prescriptions.prescription",
                            },
                ...
                const $activityButtons = $(target).find(
                    ".o_prescription_chatter_container button:contains(Activities)"
                );
                assert.strictEqual($activityButtons.length, 1);
                await legacyClick($activityButtons[0]);
            });

            QUnit.test("prescription chatter: render the activity button 2", async function (assert) {
                pyEnv["mail.activity"].create({
                    can_write: true,
                    create_uid: pyEnv.currentUserId,
                    date_deadline: serializeDate(DateTime.now()),
                    display_name: "An activity",
                    res_id: pyEnv["prescriptions.prescription"].search([])[0],
                    res_model: "prescriptions.prescription",
                    state: "today",
                ...
                assert.containsOnce(target, ".o_prescription_chatter_container .o-mail-Chatter");
                assert.containsNone(target, ".o-mail-Activity");
            });

            QUnit.test(
                "prescription chatter: can write messages in the chatter",
                async function (assert) {
                    const views = {
                        "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban">
                    <templates>
            ...
            QUnit.test(
                "prescription chatter: keep chatter open when switching between records",
                async function () {
                    const [prescriptionsPrescriptionId1, prescriptionsPrescriptionId2] = pyEnv[
                        "prescriptions.prescription"
                    ].search([]);
            ...
            QUnit.test(
                "prescription chatter: keep chatter open after a reload",
                async function (assert) {
                    const views = {
                        "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban">
                    <templates>
                        ...
                        "prescriptions.prescription,false,search": `<search>
            ...
            QUnit.test(
                "prescription chatter: close chatter when more than one record selected",
                async function (assert) {
                    const views = {
                        "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban">
                <templates>
                    ...
                    assert.containsNone(target, ".o_prescription_chatter_container .o-mail-Chatter");
                }
            );

            QUnit.test(
                "prescription chatter: close chatter when no more selected record",
                async function (assert) {
                    const views = {
                        "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban">
                <templates>
                ...
                <filter name="owo" string="OwO" domain="[['id', '&gt;', 4]]"/>
                    ...
                    assert.containsNone(
                        prescription.body,
                        ".o_prescription_chatter_container .o-mail-Chatter"
                    );
                }
            );

            QUnit.module("PrescriptionsSelector");

            QUnit.test("prescription selector: basic rendering", async function (assert) {
                assert.expect(19);
            ...
            QUnit.test("prescription selector: render without facets & tags", async function (assert) {
                assert.expect(2);
            ...
            QUnit.test("prescription selector: render without related models", async function (assert) {
                assert.expect(4);
                ...
                assert.containsNone(
                    target,
                    ".o_search_panel .o_prescriptions_selector_tags .o_search_panel_section_header",
                ...
                assert.notOk(
                    ...
                    "should not have an unattached prescription"
                );
                assert.notOk(
                    [...target.querySelectorAll(".o_search_panel_filter_value")].find(
            ...
            QUnit.test("prescription selector: filter on related model", async function (assert) {
                assert.expect(8);
            ...
            QUnit.test(
                "prescription selector: filter on attachments without related model",
                async function (assert) {
                    assert.expect(8);
            ...
            QUnit.test(
                "prescription selector: mix filter on related model and search filters",
                async function (assert) {
                    assert.expect(10);
            ...
            QUnit.test(
                "prescription selector: selected tags are reset when switching between workspaces",
                async function (assert) {
                    assert.expect(6);
                    ...
                    <div>
                        ...
                        mockRPC: function (route, args) {
                            if (
                                route ===
                                    "/web/dataset/call_kw/prescriptions.prescription/web_search_read" &&
                                args.model === "prescriptions.prescription"
                            ) {
            ...
            QUnit.test(
                "prescription selector: should keep its selection when adding a tag",
                async function (assert) {
                    assert.expect(5);
            ...
            QUnit.test("prescriptions Kanban color widget", async function (assert) {
                assert.expect(3);
                ...
                await createPrescriptionsView({
                    ...
                    arch: `<kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                    <div>
                        <field name="tag_ids" widget="prescriptions_many2many_tags"/>
                    </div>
                </t></templates></kanban>`,
                });
                ...
                assert.containsN(
                    target,
                    ".o_field_prescriptions_many2many_tags",
                    5,
                ...
                assert.containsN(
                    target,
                    ".o_kanban_record:nth-of-type(3) .o_field_prescriptions_many2many_tags .o_tag",
                    3,
                ...
                assert.hasClass(
                    target.querySelector(
                        ".o_kanban_record:nth-of-type(3) .o_field_prescriptions_many2many_tags .o_tag:nth-of-type(1)"
                    ),
                    "o_tag_color_2",
            ...
            <kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                <div draggable="true" class="oe_kanban_global_area">
                    ...
                    <field name="name"/>
                        ...
                        mockRPC: async function (route, args) {
                            if (args.method === "write" && args.model === "prescriptions.prescription") {
                                assert.deepEqual(
                                    args.args[0],
                                    [1, 2, 4],
                                ...
                                assert.step("prescriptions.prescriptions/write");
                            }
                        },
                    });
                    ...
                    // making sure that the prescriptionInspector is already rendered as it is painted after the selection.
                    ...
                    assert.verifySteps(["prescriptions.prescriptions/write"]);
                }
            );
            ...
            QUnit.test("SearchPanel: search panel should be resizable", async function (assert) {
                ...
                await testUtils.dom.dragAndDrop(resizeHandle, searchPanel, {
                    mousemoveTarget: prescription,
                    mouseupTarget: prescription,
                    position: "right",
                });
            ...
            QUnit.test("SearchPanel: regular user can not edit", async function (assert) {
                ...
                assert.containsNone(target, ".o_prescriptions_search_panel_section_edit");
            });
            ...
            QUnit.test("SearchPanel: can edit folders", async function (assert) {
                ...
                serviceRegistry.add(
                    "user",
                    makeFakeUserService((group) => group === "prescriptions.group_prescriptions_manager"),
                    { force: true }
                );
                ...
                assert.containsNone(
                    target,
                    ".o_search_panel_category_value:nth-of-type(1) .o_prescriptions_search_panel_section_edit"
                );

                triggerEvent(
                    target,
                    ".o_search_panel_category_value:nth-of-type(2) .o_prescriptions_search_panel_section_edit",
                    "click",
                    {},
                ...
                patchWithCleanup(kanban.env.services.action, {
                    doAction(action) {
                        assert.deepEqual(action, {
                            res_model: "prescriptions.folder",
                            res_id: 1,
                            name: "Edit",
                            type: "ir.actions.act_window",
                            target: "new",
            ...
            QUnit.test("SearchPanel: can edit attributes", async function (assert) {
                ...
                assert.containsOnce(tag, ".o_prescriptions_search_panel_section_edit");
                ...
                assert.containsNone(resModel, ".o_prescriptions_search_panel_section_edit");
            });

            QUnit.test(
                "SearchPanel: Trash folder is displaying inactive prescriptions",
                async function (assert) {
                    assert.expect(3);
                    await createPrescriptionsView({
                        type: "kanban",
            ...
            QUnit.test("SearchPanel: update route updates active folder", async function (assert) {
                ...
                const actions = {
                    "prescriptions.prescription_kanban_view": {
                        id: 1,
                        name: "prescription_kanban_view",
                        res_model: "prescriptions.prescription",
                        type: "ir.actions.act_window",
                        views: [[false, "kanban"]],
                    },
                ...
                await loadState(webClient, { action: "prescriptions.prescription_kanban_view" });
                await nextTick();
            ...
            QUnit.test("prescriptions: upload with default tags", async function (assert) {
                ...
                const mockedXHRs = [];
                this.patchPrescriptionXHR(mockedXHRs, (data) => {
                ...
                await dropFiles(".o_prescriptions_drop_over_zone", [file]);
                assert.verifySteps(["xhrSend"]);
            });

            QUnit.test("prescriptions: upload with context", async function (assert) {
                const file = await createFile({
                    name: "text.txt",
                    content: "hello, world",
                    contentType: "text/plain",
            ...
            QUnit.test("prescriptions: upload progress bars", async function (assert) {
                const file = await createFile({
                    name: "text.txt",
                    content: "hello, world",
                    contentType: "text/plain",
                ...
                const mockedXHRs = [];
                this.patchPrescriptionXHR(mockedXHRs, () => assert.step("xhrSend"));
            ...
            QUnit.test("prescriptions: max upload limit", async function (assert) {
                const file = await createFile({
                    name: "text.txt",
                    content: "hello, world",
                    contentType: "text/plain",
            ...
            QUnit.test("prescriptions: upload replace bars", async function (assert) {
                assert.expect(4);

                pyEnv["prescriptions.prescription"].unlink(pyEnv["prescriptions.prescription"].search([])); // reset incompatible setup
                const prescriptionsPrescriptionId1 = pyEnv["prescriptions.prescription"].create({
                    folder_id: pyEnv["prescriptions.folder"].search([])[0],
                    name: "request",
                    type: "empty",
                });
                ...
                this.patchPrescriptionXHR([], () => assert.step("xhrSend"));
                ...
                await createPrescriptionsView({
                    ...
                    arch: `
                <kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                    <div draggable="true" class="oe_kanban_global_area o_prescriptions_attachment" data-id="${prescriptionsPrescriptionId1}">
                        <field name="name"/>
                    </div>
                </t></templates></kanban>`,
                });

                await legacyClick(target.querySelector(".o_prescriptions_attachment"));
                ...
                assert.containsOnce(
                    target,
                    ".o_prescriptions_attachment .o-file-upload-progress-bar-value",
                    "there should be a progress bar"
                );
                assert.containsOnce(
                    target,
                    ".o_prescriptions_attachment .o-file-upload-progress-bar-abort",
                    "there should be cancel upload cross"
                );
            });

            QUnit.test("prescriptions: upload multiple progress bars", async function (assert) {
            ...
            <kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                ...
                await dropFiles(".o_prescriptions_drop_over_zone", [file1]);
                assert.verifySteps(["xhrSend"]);
                ...
                await dropFiles(".o_prescriptions_drop_over_zone", [file2, file3]);
                assert.verifySteps(["xhrSend"]);
            ...
            QUnit.test("prescriptions: notifies server side errors", async function (assert) {
                const file = await createFile({
                    name: "text.txt",
                    content: "hello, world",
                    contentType: "text/plain",
                ...
                const mockedXHRs = [];
                this.patchPrescriptionXHR(mockedXHRs);
            ...
            QUnit.test("prescriptions Kanban: displays youtube thumbnails", async function (assert) {
                assert.expect(1);
                ...
                assert.strictEqual(
                    target.querySelector(
                        ".o_prescriptions_inspector img, .o_prescriptions_single_preview .o_preview_available"
                    ).dataset.src,
            ...
            QUnit.test("prescriptions List: multi selection", async function (assert) {
                assert.expect(4);
            ...
            QUnit.test("prescriptions List: selection using keyboard", async function (assert) {
                assert.expect(6);
            ...
            QUnit.test("prescriptions: Versioning", async function (assert) {
                assert.expect(13);
                ...
                <kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                    ...
                    async mockRPC(route, args) {
                        ...
                        if (args.model === "prescriptions.prescription" && args.method === "write") {
                            assert.deepEqual(
                                args.args[0],
                                [prescriptionsPrescriptionId1],
                                "should target the right prescription"
                            );
                            assert.deepEqual(
                                args.args[1],
            ...
            QUnit.test("store and retrieve active category value", async function (assert) {
                ...
                const storageKey = "searchpanel_prescriptions.prescription_folder_id";
                ...
                await createPrescriptionsView({
                    ...
                    resModel: "prescriptions.prescription",
                    arch: `
                <kanban js_class="prescriptions_kanban">
                    <templates>
                    ...
                    async mockRPC(route, args) {
                        if (
                            route === "/web/dataset/call_kw/prescriptions.prescription/web_search_read" &&
                            args.model === "prescriptions.prescription"
                        ) {
            ...
            QUnit.test(
                "prescriptions kanban: unselect all by clicking outside of the records",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test(
                "prescriptions list: unselect all by clicking outside of the records",
                async function (assert) {
                    assert.expect(2);
            ...
            QUnit.test(
                "prescriptions Kanban: workspace user will be able to share prescription",
                async function (assert) {
                    assert.expect(2);
                    pyEnv["prescriptions.folder"].create({
                        name: "Workspace5",
            ...
            QUnit.test(
                "prescriptions previewer : download button on prescriptions without attachment",
                async function (assert) {
                    assert.expect(4);
                    pyEnv["prescriptions.prescription"].create({
                        folder_id: pyEnv["prescriptions.folder"].search([])[0],
                    ...
                    const views = {
                        "prescriptions.prescription,false,kanban": `<kanban js_class="prescriptions_kanban"><templates><t t-name="kanban-box">
                            <div class="o_kanban_image">
                                <div name="prescription_preview" class="o_kanban_image_wrapper" t-if="record.type.raw_value == 'url'">
                    ...
                    assert.containsOnce(target, ".o-FileViewer", "should have a prescription preview");
                    assert.containsOnce(
                        target,
                        "[title='Close (Esc)']",
                    ...
                    assert.containsNone(
                        target,
                        ".o-FileViewer",
                        "should not have a prescription preview"
                    );
                }
            );

            QUnit.test(
                "prescriptions list : uploding the requested prescriptions with multiple selection",
                async function (assert) {
                    pyEnv["prescriptions.prescription"].unlink(pyEnv["prescriptions.prescription"].search([]));
                    const prescriptionIds = pyEnv["prescriptions.prescription"].create([
                        {
                            folder_id: 1,
                            name: "request",
                            type: "empty",
                    ...
                    this.patchPrescriptionXHR([], (data) => {
                        const datas = Object.fromEntries(data.entries());
                        assert.strictEqual(
                            Number(datas.prescription_id),
                            prescriptionIds[1],
                            "The selected requsted prescription should be uploaded"
                        );
                    ...
                    await createPrescriptionsView({
                        type: "list",
                        resModel: "prescriptions.prescription",
                        arch: `<tree js_class="prescriptions_list">
                            <field name="name"/>
                        </tree>`,
                    });
                    // select 3 requested prescriptions
                    await legacyClick(target, ".o_list_record_selector.o_list_controller");
                    const fileInput = target.querySelector(".o_inspector_replace_input");
                    // legacyClick on the 2nd prescription to upload
