...
export function getEnrichedSearchArch(searchArch='<search></search>') {
    var searchPanelArch = `
        <searchpanel class="o_prescriptions_search_panel">
...
export async function createPrescriptionsView(params) {
...
export async function createPrescriptionsViewWithMessaging(params) {
