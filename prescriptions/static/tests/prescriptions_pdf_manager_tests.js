...
QUnit.module("prescriptions", {}, function () {
    QUnit.module(
        "prescriptions_pdf_manager_tests.js",
        {
            async beforeEach() {
        ...
        () => {
            QUnit.test("Pdf Manager basic rendering", async function (assert) {
                ...
                assert.containsOnce(
                    target,
                    ".o_prescriptions_pdf_manager_top_bar",
                    "There should be one top bar"
                );
                assert.containsOnce(
                    target,
                    ".o_prescriptions_pdf_page_viewer",
                ...
                assert.containsN(
                    target,
                    ".o_prescriptions_pdf_button_wrapper",
                    12,
            ...
            QUnit.test("Pdf Manager: page interactions", async function (assert) {
                ...
                await click(target.querySelectorAll(".o_prescriptions_pdf_page_selector")[3]);
                assert.containsN(
                    target,
                    ".o_pdf_page_selected",
                    11,
            ...
            QUnit.test("Pdf Manager: drag & drop", async function (assert) {
                ...
                assert.containsOnce(
                    target.querySelectorAll(".o_prescriptions_pdf_page_frame")[6],
                    ".o_pdf_name_display",
                ...
                target
                    .querySelectorAll(".o_prescriptions_pdf_canvas_wrapper")[11]
                    .dispatchEvent(startEvent);
                const endEvent = new Event("drop", { bubbles: true });
                endEvent.dataTransfer = dataTransfer;
                target
                    .querySelectorAll(".o_prescriptions_pdf_canvas_wrapper")[0]
                ...
                assert.containsOnce(
                    target.querySelectorAll(".o_prescriptions_pdf_page_frame")[7],
                    ".o_pdf_name_display",
            ...
            QUnit.test("Pdf Manager: select/Unselect all pages", async function (assert) {
                ...
                await click(target.querySelector(".o_prescriptions_pdf_page_viewer"));
                assert.containsN(
                    target,
                    ".o_pdf_page_selected",
                    0,
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    const viewer = prescription.querySelector(".o_prescriptions_pdf_page_viewer");
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    await click(target.querySelector(".o_prescriptions_pdf_page_selector"));
                    assert.containsOnce(
                        target,
                        ".o_pdf_page_selected",
                        "There should be one page selected"
            ...
            QUnit.test("Pdf Manager: arrow navigation", async function (assert) {
                ...
                assert.containsOnce(
                    target.querySelectorAll(".o_prescriptions_pdf_page_frame")[0],
                    ".o_pdf_page_focused",
                    "The first page should be focused"
                );
                await testUtils.dom.triggerEvent(window, "keydown", { key: "arrowRight" });
                assert.containsOnce(
                    target.querySelectorAll(".o_prescriptions_pdf_page_frame")[1],
                    ".o_pdf_page_focused",
            ...
            QUnit.test(
                ...
                async function (assert) {
                    ...
                    assert.containsOnce(
                        target.querySelectorAll(".o_prescriptions_pdf_page_frame")[2],
                        ".o_pdf_page_focused",
            ...
            QUnit.test("Pdf Manager: page preview behaviour", async function (assert) {
                ...
                await click(target.querySelector(".o_prescriptions_pdf_canvas_wrapper"));
