...
class ActivityDefinition(models.Model):
    ...
    _order = "name"
    _parent_order = "name"
    _inherit = ["mail.thread", "mail.activity.mixin", "podiatry.abstract"]
    ...
    def _get_activity_values(
        ...
        values = vals.copy()
        if self.type_id == self.env.ref("podiatry_workflow.podiatry_workflow"):
            values.update(self._get_podiatry_values(
