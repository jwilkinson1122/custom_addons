...
export class ProductTemplateAttributeLine extends Component {
    ...
    static template = "prescriptionProductConfigurator.ptal";
    static props = {
    ...
    getPTAVTemplate() {
        switch(this.props.attribute.display_type) {
            case 'color':
                return 'prescriptionProductConfigurator.ptav-color';
            case 'multi':
                return 'prescriptionProductConfigurator.ptav-multi';
            case 'pills':
                return 'prescriptionProductConfigurator.ptav-pills';
            case 'radio':
                return 'prescriptionProductConfigurator.ptav-radio';
            case 'select':
                return 'prescriptionProductConfigurator.ptav-select';
        }
    }
     ...
     * Note: used in `prescriptionProductConfigurator.ptav-select`.
     *
