odoo.define('prescription_product_configurator.product_configurator', function (require) {
...
ProductConfiguratorWidget.include({
    ...
    */
    ...
    _openProductConfigurator: function (data, dataPointId) {
        ...
        var self = this;
        this.do_action('prescription_product_configurator.prescription_product_configurator_action', {
