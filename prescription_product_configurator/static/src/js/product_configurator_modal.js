odoo.define('prescription_product_configurator.OptionalProductsModal', function (require) {
    "use strict";
...
var OptionalProductsModal = Dialog.extend(ServicesMixin, VariantMixin, {
    ...
    willStart: function () {
        ...
        var uri = this._getUri("/prescription_product_configurator/show_advanced_configurator");
    ...
    _onAddOption: function ($modal, $parent, productTemplateId) {
        ...
        this.selectOrCreateProduct(
            ...
            ajax.jsonRpc(self._getUri("/prescription_product_configurator/optional_product_items"), 'call', {
                'product_id': productId,
                'pricelist_id': self.pricelistId || false,
