odoo.define('prescription_product_configurator.ProductConfiguratorFormRenderer', function (require) {
"use strict";
...
var ProductConfiguratorFormRenderer = FormRenderer.extend(VariantMixin, {
    ...
    _checkMode: function () {
        if (this.state.context.configuratorMode === 'edit') {
            this.$('.o_prescription_product_configurator_add').hide();
            this.$('.o_prescription_product_configurator_edit').css('display', 'inline-block');
    ...
    _toggleDisable: function ($parent, isCombinationPossible) {
        ...
        $parent.parents('.modal').find('.o_prescription_product_configurator_add').toggleClass('disabled', !isCombinationPossible);
    },
