odoo.define('prescription_product_configurator.ProductConfiguratorFormController', function (require) {
"use strict";

var core = require('web.core');
var _t = core._t;
var FormController = require('web.FormController');
var OptionalProductsModal = require('prescription_product_configurator.OptionalProductsModal');
    ...
    */
    _onButtonClicked: function (event) {
        ...
        if (attrs.special === 'cancel') {
            ...
            if (!this.$el
                    .parents('.modal')
                    .find('.o_prescription_product_configurator_add')
                    .hasClass('disabled')) {
                this._handleAdd();
            }
        }
    ...
    _configureProduct: function (productTemplateId) {
        ...
        return this._rpc({
            route: '/prescription_product_configurator/configure',
            params: {
