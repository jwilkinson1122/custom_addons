...
tour.register('prescription_product_configurator_edition_tour', {
    url: "/web",
    test: true,
    ...
    run: function () {
        $('input.product_id').change(function () {
            if ($('.o_prescription_product_configurator_edit').attr('request_count')) {
                $('.o_prescription_product_configurator_edit').attr('request_count',
                    parseInt($('.o_prescription_product_configurator_edit').attr('request_count')) + 1);
            } else {
                $('.o_prescription_product_configurator_edit').attr('request_count', 1);
            }
        });
    }
}, {
    ...
    trigger: '.o_prescription_product_configurator_edit[request_count="2"]',
    run: function (){} // used to sync with "get_combination_info" completion
}, {
    trigger: '.o_prescription_product_configurator_edit',
}, {
    ...
    trigger: '.o_prescription_product_configurator_edit[request_count="1"]',
    run: function (){} // used to sync with "get_combination_info" completion
}, {
