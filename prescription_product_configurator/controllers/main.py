...
class ProductConfiguratorController(Controller):
    ...
    @route('/prescription_product_configurator/get_values', type='json', auth='user')
    def get_product_configurator_values(
        ...
        :param str so_date: The date of the `prescription`, to compute the price at the right rate.
    ...
    @route('/prescription_product_configurator/create_product', type='json', auth='user')
    ...
    @route('/prescription_product_configurator/update_combination', type='json', auth='user')
    ...
    @route('/prescription_product_configurator/get_optional_products', type='json', auth='user')
        ...
        :return: A dict with the following structure:
            {
                'product_tmpl_id': int,
                'id': int,
                'description_prescription': str|False,
                'display_name': str,
                'price': float,
                'quantity': int
                'attribute_line': [{
    ...
    def _get_basic_product_information(self, product_or_template, pricelist, combination, **kwargs):
        ...
        basic_information = dict(
            **product_or_template.read(['description_prescription', 'display_name'])[0]
        )
