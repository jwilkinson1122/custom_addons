...
class ProductConfiguratorController(http.Controller):
    @http.route(['/prescription_product_configurator/configure'], type='json', auth="user", methods=['POST'])
    def configure(self, product_template_id, pricelist_id, **kw):
        ...
        return request.env['ir.ui.view']._render_template("prescription_product_configurator.configure", {
    ...
    @http.route(['/prescription_product_configurator/show_advanced_configurator'], type='json', auth="user", methods=['POST'])
    ...
    @http.route(['/prescription_product_configurator/optional_product_items'], type='json', auth="user", methods=['POST'])
    ...
    def _optional_product_items(self, product_id, pricelist, **kw):
        ...
        return request.env['ir.ui.view']._render_template("prescription_product_configurator.optional_product_items", {
            'product': product,
    ...
    def _show_advanced_configurator(self, product_id, variant_values, pricelist, handle_stock, **kw):
        ...
        return request.env['ir.ui.view']._render_template("prescription_product_configurator.optional_products_modal", {
            'product': product,
