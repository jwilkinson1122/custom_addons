...
class neomatal_apgar(models.Model):
    _name = "neomatal.apgar"
    _description = "pod neomatal apgar"
    ...
    apgar_appearance = fields.Selection(
        [("0", "Central cyanosis"), ("1", "Acrosynosis"), ("2", "No Cynosis")],
        "Appearance",
    )
    apgar_grimace = fields.Selection(
        [
            ("0", "No response to simulation"),
            ("1", "Grimance when simulated"),
            ("2", "Cry Or pull away when simulated"),
        ],
        "Grimace",
    )
