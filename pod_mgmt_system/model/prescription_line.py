...
class prescription_line(models.Model):
    ...
    _description = "pod prescription line"

    name = fields.Many2one("prescription.order", "Prescription ID")
    medicament_id = fields.Many2one("medicament", "Medicament")
    ...
    dose_unit_id = fields.Many2one("dose.unit", "Dose Unit")
    qty = fields.Integer("x")
    orthotic_dosage_id = fields.Many2one("orthotic.dosage", "Frequency")
