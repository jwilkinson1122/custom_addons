...
class appointments_invoice_wizard(models.TransientModel):
    _name = "appointments.invoice.wizard"
    _description = "pod appointments invoice wizard"
    ...
    def create_invoice(self):
        ...
        for active_id in active_ids:
            ...
            if lab_req.no_invoice == False:
                ...
                invoice_vals = {
                    "name": self.env["ir.sequence"].next_by_code("app_inv_seq"),
                ...
                if lab_req.consultations_id.id:
                    invoice_line_account_id = (
                        lab_req.consultations_id.property_account_income_id.id
                        or lab_req.consultations_id.categ_id.property_account_income_categ_id.id
                        or False
                    )
                ...
                taxes = lab_req.consultations_id.taxes_id.filtered(
                    lambda r: not lab_req.consultations_id.company_id
                    or r.company_id == lab_req.consultations_id.company_id
                )
                tax_ids = taxes.ids
                invoice_line_vals = {
