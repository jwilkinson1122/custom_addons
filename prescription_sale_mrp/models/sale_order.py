...
class SaleOrder(models.Model):
    ...
    def _prepare_prescription_wizard_line_vals(self, data):
        ...
        vals = super()._prepare_prescription_wizard_line_vals(data)
    ...
    def get_delivery_prescription_data(self):
        ...
        data_list = super().get_delivery_prescription_data()
        kit_products = {
...
class SaleOrderLine(models.Model):
    ...
    def get_delivery_move(self):
        self.ensure_one()
        if self.product_id and not self._prescription_is_kit_product():
    ...
    def prepare_sale_prescription_data(self):
        ...
        self.ensure_one()
        data = super().prepare_sale_prescription_data()
        if self.product_id and self._prescription_is_kit_product():
            for d in data:
                d.update(
                    {
    ...
    def _get_kit_qty(self, product_id):
        ...
        if (
            self.product_id
            and not self._prescription_is_kit_product()
    ...
    def _prescription_is_kit_product(self):
