...

{
    ...
    'assets': {
        'point_of_sale.assets': [
            ...
            "bi_pos_modify_own_pizza/static/src/js/ProductTemplateListWidget.js",
            ...
            "bi_pos_modify_own_pizza/static/src/js/models.js",
            "bi_pos_modify_own_pizza/static/src/js/Popups/ModifierProductPopup.js"
        ],
        'web.assets_qweb': [
            'bi_pos_modify_own_pizza/static/src/xml/**/*',
        ],
    },
    'license': 'OPL-1',
    "auto_install": False,
