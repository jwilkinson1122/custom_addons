odoo.define("bi_pos_modify_own_pizza.screens", function(require){
	"use strict";
	...
	models.load_fields('product.product', ['modifier_attribute_product_id','pizza_pieces','sub_products_ids']);
