...
class PodiatryEncounterValidationAddService(models.TransientModel):
    _name = "pod.encounter.validation.add.service"
    ...
    careplan_id = fields.Many2one("pod.careplan", required=False)
    ...
    def run(self):
        ...
        result = super(
            PodiatryEncounterValidationAddService,
