...
class TestReport(common.HttpCase):
        ...
        self.report_pdf_view = self.env["ir.ui.view"].create(
            {
                "name": "Test",
                "type": "qweb",
                "arch": """<t t-name="pod_report_to_printer.test">
                <div>Test</div>
            </t>""",
            }
        )
        ...
        self.report_text_view = self.env["ir.ui.view"].create(
            {
                "name": "Test",
                "type": "qweb",
                "arch": """<t t-name="pod_report_to_printer.test_text">
                Test
                </t>""",
            }
        )
        ...
        self.report = self.Model.create(
            {
                ...
                "model": "res.partner",
                "report_name": "pod_report_to_printer.test_pdf",
            }
        )
        self.report_text = self.Model.create(
            {
                ...
                "model": "res.partner",
                "report_name": "pod_report_to_printer.test_text",
            }
        )
    ...
    def test_render_qweb_pdf_not_printable(self):
        ...
        with mock.patch(
            "odoo.addons.pod_report_to_printer.models."
