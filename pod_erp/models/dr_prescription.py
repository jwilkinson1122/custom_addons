...
class DrPrescription(models.Model):
    ...
    def default_device_examination_chargeable(self):
        settings_device_examination_chargeable = self.env['ir.config_parameter'].sudo().get_param(
            'device_examination_chargeable')
        return settings_device_examination_chargeable

    device_examination_chargeable = fields.Boolean(
        default=default_device_examination_chargeable, readonly=1)
    ...
    ph = fields.Text('P.H')
    cie_10 = fields.Selection([('cataract_device', 'Cataract Eye'), ('pterygium', "Pterygium"), ('glaucoma', 'Glaucoma'), ('squint', 'Squint'), ('detachment', 'Detachment'), (
    ...
    family_device_history = fields.Text()
    ...
    #     return {
    #         'type': 'ir.actions.report',
    #         'report_name': "pod_erp.doctor_podiatric_prescription_template",
    #         'report_file': "pod_erp.doctor_podiatric_prescription_template",
    #         'report_type': 'qweb-pdf',
    #     }

    def print_podiatric_prescription_report_ticket_size(self):
        return self.env.ref("pod_erp.doctor_prescription_podiatric_ticket_size2").report_action(self)
