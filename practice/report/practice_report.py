...
class PrescriptionReport(models.AbstractModel):
    _name = "report.practice.report_practice_prescription"
    _description = "Auxiliar to get the report"

    def _get_prescription_data(self, date_start, date_end):
        total_amount = 0.0
        data_prescription = []
        prescription_obj = self.env["practice.prescription"]
        act_domain = [
    ...
    def _get_report_values(self, docids, data):
        ...
        prescription_profile = self.env["practice.prescription"].browse(docids)
