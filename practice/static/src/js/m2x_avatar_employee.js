/** @odoo-module alias=podiatry.Many2OneAvatarEmployee **/
...
// field widgets, to support fields pointing to 'podiatry.employee'. It also defines the
...
const M2XAvatarEmployeeMixin = {
    supportedModels: ['podiatry.employee', 'podiatry.employee.public'],
