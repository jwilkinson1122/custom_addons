odoo.define('podiatry.employee_chat', function (require) {
    'use strict';
    ...
    const ChatMixin = require('podiatry.chat_mixin');
    ...
    const EmployeeFormController = FormController.extend(EmployeeArchiveMixin, {
        /**
         * Override the archive action to directly open the inactive wizard
         * @override
         * @private
         */
    ...
    viewRegistry.add('podiatry_employee_form', EmployeeFormView);
    ...
    viewRegistry.add('podiatry_employee_list', EmployeeListView);
    ...
    viewRegistry.add('podiatry_employee_kanban', EmployeeKanbanView);
});
