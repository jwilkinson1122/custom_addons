/** @odoo-module **/
    ...
    import StandaloneM2OAvatarEmployee from '@podiatry/js/standalone_m2o_avatar_employee';
        ...
        QUnit.module('StandaloneM2OEmployeeTests', {
            beforeEach: function () {
                this.data = {
                    'foo': {
                        fields: {
                            employee_id: {string: "Employee", type: 'many2one', relation: 'podiatry.employee'},
                        },
                        records: [],
                    },
                    'podiatry.employee': {
