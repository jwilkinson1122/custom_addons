...
class TestPrescriptionPrices(PrescriptionCommon):
    ...
    def test_pricelist_dates(self):
        ...
        self.assertEqual(
            ...
            self.product.lst_price * 3.8)  # Discount of 10% on 2 osf the 4 rxl
    ...
    def test_update_prices(self):
        ...
        rx_amount = prescriptions_order.amount_total
        start_rx_amount = rx_amount
        prescriptions_order._recompute_prices()
        self.assertEqual(
            prescriptions_order.amount_total, rx_amount,
        ...
        self.assertEqual(prescriptions_order.amount_undiscounted, rx_amount)
        self.assertEqual(prescriptions_order.amount_total, 0.95*rx_amount)
        ...
        self.assertEqual(prescriptions_order.amount_undiscounted, rx_amount)
        self.assertEqual(
            prescriptions_order.amount_total, start_rx_amount,
