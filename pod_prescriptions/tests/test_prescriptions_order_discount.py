...
class TestPrescriptionOrderDiscount(PrescriptionCommon):
    ...
    def test_rx_discount(self):
        rxlines = self.prescriptions_order.order_line
        ...
        discount_line = self.prescriptions_order.order_line - rxlines
        ...
        self.wizard.action_apply_discount()
        discount_lines = self.prescriptions_order.order_line - rxlines
    ...
    def test_rxl_discount(self):
        rx_amount = self.prescriptions_order.amount_untaxed
        self.wizard.write({
            'discount_percentage': 0.5,  # 50%
        ...
        self.assertAlmostEqual(self.prescriptions_order.amount_untaxed, rx_amount*0.5)
