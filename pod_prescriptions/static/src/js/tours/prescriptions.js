...
registry.category("web_tour.tours").add("prescriptions_tour", {
    ...
    trigger: ".o_app[data-menu-xmlid='pod_prescriptions.prescriptions_menu_root']",
    content: _t("Open Prescriptions app to send your first quotation in a few clicks."),
    position: "right",
    edition: "community"
}, {
    trigger: ".o_app[data-menu-xmlid='pod_prescriptions.prescriptions_menu_root']",
    ...
    extra_trigger: ".o_prescriptions_order",
...
}, stepUtils.showAppsMenuItem(),
{
    ...
    trigger: 'a.o_onboarding_step_action.btn[data-method=action_open_step_prescriptions_order_confirmation]',
    extra_trigger: ".o_prescriptions_order",
    content: _t("To speed up order confirmation, we can activate electronic signatures or payments."),
    position: "bottom",
    skip_trigger: 'a[data-method=action_open_step_prescriptions_order_confirmation].o_onboarding_step_action__done',
}, {
...
registry.category("web_tour.tours").add("prescriptions_quote_tour", {
        url: "/web#action=pod_prescriptions.action_quotations_with_onboarding&view_type=form",
        rainbowMan: true,
