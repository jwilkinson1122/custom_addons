...
class ProductAttributeCustomValue(models.Model):
    ...
    _sql_constraints = [
        ('rxl_custom_value_unique', 'unique(custom_product_template_attribute_value_id, prescriptions_order_line_id)', "Only one Custom Value is allowed per Attribute Value per Prescriptions Order Line.")
    ]
