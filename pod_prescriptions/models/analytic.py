...
class AccountAnalyticLine(models.Model):
    ...
    allowed_rx_line_ids = fields.Many2many('prescriptions.order.line', compute='_compute_allowed_rx_line_ids')
    rx_line = fields.Many2one('prescriptions.order.line', string='Prescriptions Order Item', domain="[('id', 'in', allowed_rx_line_ids)]")
    ...
    def _compute_allowed_rx_line_ids(self):
        for timesheet in self:
            ...
            timesheet.allowed_rx_line_ids = self.env['prescriptions.order.line'].search(domain)
