...
class PrescriptionOrderLine(models.Model):
    ...
    def _compute_qty_delivered(self):
        """ This method compute the delivered quantity of the SO lines: it covers the case provide by prescriptions module, aka
    ...
    def _compute_invoice_status(self):
        ...
        - no: if the SO is not in status 'prescriptions', we consider that there is nothing to
        ...
        - upselling: this is possible only for a product invoiced on ordered quantities for which
          ...
          occurs only in state 'prescriptions', the upselling opportunity is removed from the list.
