...
class CrmTeam(models.Model):
    ...
    def action_primary_channel_button(self):
        if self._in_prescriptions_scope():
            return self.env["ir.actions.actions"]._for_xml_id("pod_prescriptions.action_order_report_rx_prescriptions_team")
    ...
    def _unlink_except_used_for_prescriptions(self):
        ...
        RX_COUNT_TRIGGER = 5
        for team in self:
            if team.prescriptions_order_count >= RX_COUNT_TRIGGER:
                raise UserError(
