...
class UtmCampaign(models.Model):
    ...
    quotation_count = fields.Integer('Draft Rx Count',
        compute="_compute_quotation_count", compute_sudo=True, groups='pod_prescriptions_team.group_prescriptions_personnel')
    invoiced_amount = fields.Integer(string="Revenues generated by the campaign",
        compute="_compute_prescriptions_invoiced_amount", compute_sudo=True, groups='pod_prescriptions_team.group_prescriptions_personnel')
