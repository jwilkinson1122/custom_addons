...
class Prescription(models.Model):
    ...
    def _link_refund_with_reception_move(self):
        """Perform the internal operations for linking the Prescription reception move with the
    ...
    def _unlink_refund_with_reception_move(self):
        """Perform the internal operations for unlinking the Prescription reception move with the
        sales order line.
        """
        self.ensure_one()
    ...
    def _prepare_refund_line_vals(self):
        """Add line data and link to the sales order, only if the Prescription is for the whole
