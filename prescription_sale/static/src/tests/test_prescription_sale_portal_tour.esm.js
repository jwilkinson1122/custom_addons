    ...
    [
        {
            ...
            trigger: 'a:containsExact("Test Sale Prescription SO")',
        },
        {
            content: "Open the Prescription request pop-up",
            trigger: 'a:contains("Request Prescriptions")',
        },
        {
            content:
        ...
        },
        {
            ...
            trigger: ".o_prescription_portal_shipping_card:contains('Another address')",
            run: "click",
        },
        {
            content: "Submit the Prescription",
            trigger: "button[type='submit']",
        },
        {
            content: "We're redirected to the new draft Prescription",
            trigger: "h5:contains('Prescription Order')",
        },
        {
            content: "We're redirected to the new draft Prescription",
            trigger: "h5:contains('Prescription Order')",
