odoo.define("prescription_sale.animation", function (require) {
    "use strict";

    const publicWidget = require("web.public.widget");

    /**
     * Adds some machinery to the customer portal Prescription form:
     *
     ...
     */
    publicWidget.registry.PrescriptionPortalSale = publicWidget.Widget.extend({
        selector: "#form-request-prescription",
        events: {
            "change .prescription-operation": "_onChangeOperationId",
            "change #delivery-prescription-qty input": "_onChangeQty",
            "click .o_prescription_portal_shipping_card": "_onChangeShippingAddress",
        },
        ...
        start: function () {
            const ids = this.$("[name*='-operation_id']")
                ...
                .get();
            this.$submit = $("#form-request-prescription button[type='submit']");
            this.rows_ids = ids;
        ...
        _onChangeShippingAddress: function (ev) {
            ...
            $address_container
                .find(".o_prescription_portal_shipping_card")
