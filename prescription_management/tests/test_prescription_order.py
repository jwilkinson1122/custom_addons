...
class TestPrescriptionOrder(PrescriptionManagementCommon):
    ...
    def test_01_template_without_pricelist(self):
        ...
        self.prescription_order.prescription_order_option_ids[0].button_add_to_prescription()
    ...
    def test_option_price_unit_is_not_recomputed(self):
        ...
        prescription_order_with_option.prescription_order_option_ids.add_option_to_prescription()
