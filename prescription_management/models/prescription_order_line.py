...
class PrescriptionOrderLine(models.Model):
    ...
    def _compute_name(self):
        ...
        super()._compute_name()
        for line in self:
            if line.product_id and line.prescription_order_id.prescription_order_template_id and line._use_template_name():
                for template_line in line.prescription_order_id.prescription_order_template_id.prescription_order_template_line_ids:
                    if line.product_id == template_line.product_id:
                        lang = line.prescription_order_id.partner_id.lang
    ...
    def _compute_price_unit(self):
        ...
        super(PrescriptionOrderLine, self - lines_without_price_recomputation)._compute_price_unit()
    ...
    def _can_be_edited_on_portal(self):
        return self.prescription_order_id._can_be_edited_on_portal() and (
            self.prescription_order_option_ids
            or self.product_id in self.prescription_order_id.prescription_order_option_ids.product_id
        )
