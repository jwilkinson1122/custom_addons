...
class PrescriptionTemplateOption(models.Model):
    _name = "prescription.template.option"
    ...
    company_id = fields.Many2one(
        related='prescription_template_id.company_id', store=True, index=True)
    ...
    def _prepare_option_line_values(self):
        ...
        :return: `prescription.option` create values
        :rtype: dict
        """
        self.ensure_one()
        return {
