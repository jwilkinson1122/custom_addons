...
class Digest(models.Model):
    ...
    def _compute_kpi_prescription_total_value(self):
        if not self.env.user.has_group('prescription_team.group_prescription_personnel_all_leads'):
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_all_prescription_total'] = 'prescription.report_all_channels_prescription_action&menu_id=%s' % self.env.ref('prescription.prescription_menu_root').id
        return res
