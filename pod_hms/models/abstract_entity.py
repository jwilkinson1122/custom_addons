...
class PodiatryAbstractEntity(models.AbstractModel):
    _name = 'pod.abstract.entity'
    _description = 'Podiatry Abstract Entity'
    ...
    def create(self, vals):
        ...
        return super(PodiatryAbstractEntity, self).create(vals)

    def toggle_active(self):
        """ It toggles patient and partner activation. """
        for record in self:
            super(PodiatryAbstractEntity, self).toggle_active()
            if record.active:
