...
class PrescriptionReportWizard(models.TransientModel):
    _name = "pod.prescription.report.wizard"
    ...
    def action_print_report(self):
        ...
        prescriptions = self.env['pod.prescription'].search_read(domain)

        data = {
            'form_data': self.read()[0],
            'prescriptions': prescriptions
        }
        return self.env.ref('pod_hms.action_report_prescription_card').report_action(self, data=data)
