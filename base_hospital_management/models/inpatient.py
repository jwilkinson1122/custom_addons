...
class Patient(models.Model):
    ...
    attending_doctor = fields.Many2one('res.partner',string="Attending Doctor", domain="[('is_doctor','=','doctor')]")
    operating_doctor = fields.Many2one('res.partner',string="Operating Doctor", domain="[('is_doctor','=','doctor')]")
