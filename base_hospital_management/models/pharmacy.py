...
class Pharmacy(models.Model):
    ...
    pharmacist_name = fields.Many2one('res.partner', string="Pharmacist's Name",
                                      domain=[('hospital_role', '=', 'Pharmacist')])
    ...
    doctor_ids = fields.One2many('res.partner', 'pharmacy_id', "Prescription")
...
class Prescription(models.Model):
    ...
    doctor_name = fields.Char('Doctor Name', related='doctor_id.name')
    
    # hospital_id = fields.Many2one('res.partner', 'Hospital')
    hospital_id = fields.Many2one('res.partner', domain=[(
        'is_hospital', '=', True)], string="Hospital", required=True)
    hospital_name = fields.Char('Hospital Name', related='hospital_id.name')
