...
class Patients(models.Model):
    ...
    # doctor_id = fields.Many2one('res.partner', string="Primary Doctor",
    #                             domain="[('is_doctor','=','doctor')]")
    hospital_id = fields.Many2one('res.partner', domain=[('is_hospital', '=', True)], string="Hospital", required=True)
    # hospital_id = fields.Many2one('res.partner', string="Primary Doctor",
    #                             domain="[('is_hospital','=','hospital')]")
    hospital_name = fields.Char(string='Hospital', related='hospital_id.name')
