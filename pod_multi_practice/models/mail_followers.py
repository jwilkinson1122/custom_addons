...
class MailFollowers(models.Model):
    ...
    def write(self, vals):
        ...
        if self.res_model in subtypes_map and "subtype_ids" in vals:
            ...
            if (
                external_subtype in self.subtype_ids
                and internal_subtype in self.subtype_ids
            ):
