    ...
    def _track_template(self, changes):
        ...
        if external:
            ...
            res[first_external_field] = (
                self.env.ref("pod_multi_practice.mail_template_patient_status_update"),
                {
                    "subtype_id": self.env.ref(
                        "pod_multi_practice.subtype_patient_external_update"
                    ).id,
        ...
        if "practice_info_notes" in changes:
            res["practice_info_notes"] = (
                self.env.ref(
                    "pod_multi_practice.mail_template_patient_new_internal_note"
                ),
                {
                    "subtype_id": self.env.ref(
                        "pod_multi_practice.subtype_patient_internal_update"
                    ).id,
                    "email_layout_xmlid": "mail.mail_notification_light",
                },
            )
