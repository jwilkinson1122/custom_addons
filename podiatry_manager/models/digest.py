...
class Digest(models.Model):
    ...
    def _compute_kpi_pos_total_value(self):
        if not self.env.user.has_group('podiatry_manager.group_pos_user'):
            raise AccessError(
    ...
    def _compute_kpis_actions(self, company, user):
        ...
        res['kpi_pos_total'] = 'podiatry_manager.action_pos_sale_graph&menu_id=%s' % self.env.ref(
            'podiatry_manager.menu_point_root').id
        return res
