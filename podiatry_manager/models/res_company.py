...
class ResCompany(models.Model):
    ...
    podiatry_manager_update_stock_quantities = fields.Selection([
        ...
        for record in self:
            ...
            if sessions_in_period:
                ...
                raise ValidationError(
                    _("Please close all the point of sale sessions in this period before closing it. Open sessions are: %s ") % (sessions_str))
