...
class PosOrder(models.Model):
    ...
    def _get_pos_anglo_saxon_price_unit(self, product, partner_id, quantity):
        ...
        price_unit = product.with_company(
            self.company_id)._compute_average_price(0, quantity, moves)
        return price_unit
    ...
    def _launch_stock_rule_from_pos_order_lines(self):
        ...
        for order in orders:
            ...
            if pickings_to_confirm:
                ...
                lines_by_tracked_product = groupby(sorted(
                    tracked_lines, key=lambda l: l.product_id.id), key=lambda l: l.product_id.id)
                for product, lines in lines_by_tracked_product:
                    ...
                    moves._add_mls_related_to_order(
                        lines, are_qties_done=False)
