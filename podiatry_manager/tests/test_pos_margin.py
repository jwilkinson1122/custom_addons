...
class TestPosMargin(TestPoSCommon):
    ...
    def test_positive_margin(self):
        ...
        self.assertEqual(
            round(self.pos_session.order_ids[2].margin_percent, 2), 0.42)
    ...
    def test_negative_margin(self):
        ...
        self.assertEqual(
            round(self.pos_session.order_ids[2].margin_percent, 2), -0.92)
    ...
    def test_avco_margin_closing_time(self):
        ...
        product1 = self.create_product('Product 1', self.categ_anglo, 10, 5)
        product2 = self.create_product('Product 2', self.categ_basic, 50, 30)
        self.env.company.podiatry_manager_update_stock_quantities = 'closing'
        ...
        self.env.company.podiatry_manager_update_stock_quantities = 'real'
