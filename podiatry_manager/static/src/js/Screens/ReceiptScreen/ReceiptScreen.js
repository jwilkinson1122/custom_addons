odoo.define('podiatry_manager.ReceiptScreen', function (require) {
    'use strict';

    const { Printer } = require('podiatry_manager.Printer');
    const { is_email } = require('web.utils');
    const { useRef, useContext } = owl.hooks;
    const { useErrorHandlers, onChangeOrder } = require('podiatry_manager.custom_hooks');
