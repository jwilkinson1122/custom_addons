odoo.define('podiatry_manager.ProductScreen', function(require) {
    'use strict';

    const PosComponent = require('podiatry_manager.PosComponent');
    const ControlButtonsMixin = require('podiatry_manager.ControlButtonsMixin');
    const NumberBuffer = require('podiatry_manager.NumberBuffer');
    const { useListener } = require('web.custom_hooks');
    const Registries = require('podiatry_manager.Registries');
    const { onChangeOrder, useBarcodeReader } = require('podiatry_manager.custom_hooks');
    const { isConnectionError, posbus } = require('podiatry_manager.utils');
