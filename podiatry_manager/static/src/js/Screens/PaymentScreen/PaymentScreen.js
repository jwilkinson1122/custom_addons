odoo.define('podiatry_manager.PaymentScreen', function (require) {
    'use strict';

    const { parse } = require('web.field_utils');
    const PosComponent = require('podiatry_manager.PosComponent');
    const { useErrorHandlers, useAsyncLockedMethod } = require('podiatry_manager.custom_hooks');
    const NumberBuffer = require('podiatry_manager.NumberBuffer');
    const { useListener } = require('web.custom_hooks');
    const Registries = require('podiatry_manager.Registries');
    const { onChangeOrder } = require('podiatry_manager.custom_hooks');
    const { isConnectionError } = require('podiatry_manager.utils');
