odoo.define('podiatry_manager.tour.ProductConfigurator', function (require) {
    'use strict';

    const { ProductScreen } = require('podiatry_manager.tour.ProductScreenTourMethods');
    const { ProductConfigurator } = require('podiatry_manager.tour.ProductConfiguratorTourMethods');
