odoo.define('podiatry_manager.tour.ProductScreen', function (require) {
    'use strict';

    const { ProductScreen } = require('podiatry_manager.tour.ProductScreenTourMethods');
    const { TextAreaPopup } = require('podiatry_manager.tour.TextAreaPopupTourMethods');
...
odoo.define('podiatry_manager.tour.FixedPriceNegativeQty', function (require) {
    'use strict';
