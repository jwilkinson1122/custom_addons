odoo.define('podiatry_manager.tour.utils', function (require) {
    'use strict';
     ...
     *
     * ```
     * const { startSteps, getSteps, createTourMethods } = require('podiatry_manager.utils');
     * const { Other } = require('podiatry_manager.tour.OtherMethods');
     *
