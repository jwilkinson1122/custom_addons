odoo.define('podiatry_manager.tour.TicketScreen', function (require) {
    'use strict';
    ...
    const { TicketScreen } = require('podiatry_manager.tour.TicketScreenTourMethods');
    const { ErrorPopup } = require('podiatry_manager.tour.ErrorPopupTourMethods');
    const { Chrome } = require('podiatry_manager.tour.ChromeTourMethods');
    const { getSteps, startSteps } = require('podiatry_manager.tour.utils');
