...
class DownloadStatementReport(http.Controller):
    ...
    def download_customer_filter_statement(self, statement_id, report_type=None, access_token=None, message=False, download=False, **kw):
        ...
        report_type = 'pdf'
        download = True
        return self._show_report(model=statement_sudo, report_type=report_type, report_ref='podiatry.action_report_customer_filtered_statement', download=download)
    ...
    def download_customer_statement(self, statement_id, report_type=None, access_token=None, message=False, download=False, **kw):
        ...
        report_type = 'pdf'
        download = True
        return self._show_cs_report(model=statement_sudo, report_type=report_type, report_ref='podiatry.action_report_customer_statement', download=download)
    ...
    def download_customer_due_statement(self, statement_id, report_type=None, access_token=None, message=False, download=False, **kw):
        ...
        report_type = 'pdf'
        download = True
        return self._show_cds_report(model=statement_sudo, report_type=report_type, report_ref='podiatry.action_report_customer_due_statement', download=download)
