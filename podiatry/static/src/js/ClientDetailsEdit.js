odoo.define('podiatry.ClientDetailsEdit', function (require) {
	'use strict';
	...
	const PodiatryClientDetailsEdit = ClientDetailsEdit =>
	...
	Registries.Component.extend(ClientDetailsEdit, PodiatryClientDetailsEdit);
