...
class CompletePairOrder(models.TransientModel):
    ...
    practice_id = fields.Char(
        related='prescription_id.practice_id.name', required=True)
    practitioner_id = fields.Char(
        related='prescription_id.practitioner_id.name', required=True)
    patient_id = fields.Char(
        related='prescription_id.patient_id.name', required=True)
