...
class podiatry_patient_disease(models.Model):
    _name = "podiatry.patient.disease"
    _description = 'podiatry patient disease'
    _rec_name = 'patient_id'

    pathology_id = fields.Many2one('podiatry.pathology','Disease', required=True)
