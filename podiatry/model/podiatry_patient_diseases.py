...
class podiatry_patient_diseases(models.Model):
    _name = 'podiatry.patient.diseases'
    _description = 'podiatry patient diseases'
    
    pathelogh_id = fields.Many2one('podiatry.pathology', 'Disease')
