...
class podiatry_inpatient_diet(models.Model):
    ...
    diet_id = fields.Many2one('podiatry.diet.therapeutic',string='Diet',required=True)
    remarks = fields.Text(string=' Remarks / Directions ')
    podiatry_inpatient_registration_id = fields.Many2one('podiatry.inpatient.registration',string='Inpatient Id')
