...
class podiatry_patient_rounding(models.Model):
    ...
    podiatry_inpatient_registration = fields.Many2one('podiatry.inpatient.registration',string="Registration Code",required=True)
    ...
    chest_drainages = fields.One2many('podiatry.icu.chest_drainage','podiatry_patient_rounding_chest_drainage_id',string="Chest Drainages")
    ...
    procedures_ids = fields.One2many('podiatry.rounding_procedure','podiatry_patient_rounding_procedure_id',string="Procedures")
    practice_location_id = fields.Many2one('stock.location',string='Practice Location')
    medicaments_ids = fields.One2many('podiatry.patient.rounding.medicament','podiatry_patient_rounding_medicament_id',string="Medicaments")
    podiatry_supplies_ids = fields.One2many('podiatry.patient.rounding.podiatry_supply','podiatry_patient_rounding_podiatry_supply_id',string='Podiatry Supplier')
    vaccines_ids = fields.One2many('podiatry.patient.rounding.vaccine','podiatry_patient_rounding_vaccine_id',string='Vaccines')
