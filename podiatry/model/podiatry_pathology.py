...
class podiatry_pathology(models.Model):
    ...
    category_id = fields.Many2one('podiatry.pathology.category',string="Disease Category")
    line_ids = fields.One2many('podiatry.pathology.group.member','disease_group_id',string="Group")
