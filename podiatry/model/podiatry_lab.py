...
class podiatry_lab(models.Model):
    ...
    podiatry_lab_physician_id = fields.Many2one('podiatry.physician','Pathologist')
    requestor_physician_id = fields.Many2one('podiatry.physician','Physician', required = True)
    critearea_ids = fields.One2many('podiatry_test.critearea','podiatry_lab_id', 'Critearea')
