...
class podiatry_icu_glasgow(models.Model):
    _name = 'podiatry.icu.glasgow'
    _description ='Podiatry Icu Glasgow'
    _rec_name = 'podiatry_inpatient_registration_id'

    podiatry_inpatient_registration_id = fields.Many2one('podiatry.inpatient.registration',string="Registration Code",required=True)
