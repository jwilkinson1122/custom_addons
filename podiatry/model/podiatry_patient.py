...
class podiatry_patient(models.Model):
    ...
    def print_report(self):
        return self.env.ref('podiatry.report_print_patient_card').report_action(self)
    ...
    current_insurance_id = fields.Many2one('podiatry.insurance',string="Insurance")
    ...
    patient_status = fields.Char(string="Practice Status",readonly=True)
    patient_disease_ids = fields.One2many('podiatry.patient.disease','patient_id')
    ...
    menstrual_history_ids = fields.One2many('podiatry.patient.menstrual.history','patient_id')
    ...
    mammography_history_ids = fields.One2many('podiatry.patient.mammography.history','patient_id')
    pap_history_ids = fields.One2many('podiatry.patient.pap.history','patient_id')
    colposcopy_history_ids = fields.One2many('podiatry.patient.colposcopy.history','patient_id')
    ...
    pregnancy_history_ids = fields.One2many('podiatry.patient.pregnency','patient_id')
    family_history_ids = fields.Many2many('podiatry.family.disease',string="Family Disease Lines")
    ...
    podiatry_vaccination_ids = fields.One2many('podiatry.vaccination','podiatry_patient_vaccines_id')
    podiatry_appointments_ids = fields.One2many('podiatry.appointment','patient_id',string='Appointments')
    lastname = fields.Char('Last Name')
    report_date = fields.Date('Date',default = datetime.today().date())
    medication_ids = fields.One2many('podiatry.patient.medication1','podiatry_patient_medication_id')
