...
class ProductConfigSession(models.Model):
    ...
    def update_session_configuration_value(self, vals, product_tmpl_id=None):
        ...
        podiatry_obj = self.env["product.configurator"]
        field_prefix = podiatry_obj._prefixes.get("field_prefix")
        custom_field_prefix = podiatry_obj._prefixes.get(
            "custom_field_prefix"
        )
    ...
    def search_variant(self, value_ids=None, product_tmpl_id=None):
        ...
        more_attrs = products.filtered(
            lambda p: len(
                p.product_template_attribute_value_ids) != len(value_ids)
        )
        products -= more_attrs
        return products
