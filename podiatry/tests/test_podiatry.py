...
class TestPodiatry(common.TransactionCase):
    def setUp(self):
        ...
        self.practitioner_obj = self.env["podiatry.practitioner"]
        ...
        self.practice_id = self.env.ref("podiatry.demo_podiatry_1")
        ...
        self.doctor = self.env.ref("podiatry.demo_patient_doctor_1")
        ...
        self.doctor.patient_id = [(6, 0, patient_list)]
    ...
    def test_podiatry(self):
        self.assertEqual(
            self.patient_patient.practice_id,
            self.patient_patient.standard_id.practice_id,
        )
