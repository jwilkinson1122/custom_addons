...
class TestPodiatry(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.teacher_obj = self.env['podiatry.teacher']
        self.parent_obj = self.env['podiatry.parent']
        self.podiatry_obj = self.env['podiatry.podiatry']
        ...
        self.student_student = self.env.ref('podiatry.demo_student_student_2')
        self.student_done = self.env.ref('podiatry.demo_student_student_6')
        self.parent = self.env.ref('podiatry.demo_student_parent_1')
