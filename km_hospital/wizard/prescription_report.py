...
class PrescriptionReportWizard(models.TransientModel):
    ...
    patient_id = fields.Many2one(
        'kmhospital.patient', string="Patient", required=True)
    ...
    def action_print_report(self):
        ...
        prescriptions = self.env['kmhospital.prescription'].search_read(
            domain)
        ...
        return self.env.ref('km_hospital.action_report_prescription_card').report_action(self, data=data)
