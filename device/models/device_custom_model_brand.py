...
class DeviceCustomModelBrand(models.Model):
    _name = 'device.custom.model.brand'
    _description = 'Brand of the custom'
    _order = 'name asc'
    ...
    model_ids = fields.One2many('device.custom.model', 'brand_id')

    @api.depends('model_ids')
    def _compute_model_count(self):
        model_data = self.env['device.custom.model']._read_group([
