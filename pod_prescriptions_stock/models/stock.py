...
class StockPicking(models.Model):
    ...
    def _action_done(self):
        ...
        for move in self.move_ids:
            ...
            # Creates new SO line only when pickings linked to a prescriptions order and
            ...
            if product.invoice_policy == 'delivery':
                ...
                so_line = prescriptions_order.order_line.filtered(lambda sol: sol.product_id == product)
                if so_line:
            ...
            prescriptions_order_lines_vals.append(so_line_vals)
