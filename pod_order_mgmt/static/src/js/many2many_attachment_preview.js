odoo.define('pod_order_management.many2many_attachment_preview_widget', function (require) {
    "use strict";

    var AbstractField = require('web.AbstractField');
    var core = require('web.core');
    var registry = require('web.field_registry');
    var DocumentViewer = require('pod_order_management.legacy.DocumentViewer');
