...
class TestDeviceConfiguratorPrice(TestProductDeviceConfiguratorCommon):
        ...
        cfg = self.DeviceConfigure.create(
            {
                ...
                'design_id': self.device_design_f.id,
                'material_id': self.device_material_brass_7.id,
                'finishing_id': self.device_finishing_nickel.id,
                'difficulty_id': self.device_difficulty_a.id,
                'size_length': 15,
                'size_width': 10,
                'quantity_dies': 10,
        ...
        cfg = self.DeviceConfigure.create(
            {
                ...
                'partner_id': self.partner_azure.id,
                'die_id': self.device_die_default.id,
                'design_id': self.device_design_fe.id,
    ...
    def test_08_calc_mold_price_free_disabled(self):
        # GIVEN
        self.device_pricelist_deco.quantity_die_mold_free = 0
        cfg = self.DeviceConfigure.create(
            {
                'sequence': 1,
                'partner_id': self.partner_deco.id,
    ...
    def test_09_calc_die_price_under_minimum_area(self):
        ...
        self.device_pricelist_azure.min_area = 200
        cfg = self.DeviceConfigure.create(
            {
                'sequence': 1,
                'partner_id': self.partner_azure.id,
