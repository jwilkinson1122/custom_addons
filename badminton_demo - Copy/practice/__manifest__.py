# -*- coding: utf-8 -*-
{
    ...
    "name": "Practice",
    "summary": "Manage memberships for any kind of practice.",
    "description": """
...
- memberships: allows to manage members lifecycle, regarding the period, category and price defined
    ...
    "assets": {
        "web.assets_frontend": [
            "practice/static/src/scss/membership.scss",
        ],
        "web.assets_backend": [
            "practice/static/src/scss/kanban_view.scss",
        ],
    },
    "qweb": [],
    "demo": [
