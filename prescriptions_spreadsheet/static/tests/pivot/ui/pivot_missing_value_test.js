...
QUnit.module("prescriptions_spreadsheet > Pivot missing values", {}, function () {
    QUnit.test("Open pivot dialog and insert a value, with UNDO/REDO", async function (assert) {
        ...
        await nextTick();
        assert.containsOnce(prescription.body, ".o_pivot_table_dialog");
        await click(prescription.body.querySelectorAll(".o_pivot_table_dialog tr th")[1]);
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await doMenuAction(topbarMenuRegistry, insertPivotCellPath, env);
            await nextTick();
            assert.containsOnce(prescription.body, ".o_missing_value");
            await click(prescription.body.querySelector("input#missing_values"));
            await nextTick();
            assert.containsOnce(prescription.body, ".o_missing_value");
            assert.containsN(prescription.body, ".o_pivot_table_dialog th", 4);
            await click(prescription.body.querySelector(".o_missing_value"));
    ...
    QUnit.test("Insert missing pivot value with two level of grouping", async function (assert) {
        ...
        await nextTick();
        assert.containsOnce(prescription.body, ".o_missing_value");
        assert.containsN(prescription.body, ".o_pivot_table_dialog td", 1);
        assert.containsN(prescription.body, ".o_pivot_table_dialog th", 4);
    });
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await nextTick();
            assert.containsOnce(prescription.body, ".o_missing_value");
            assert.containsN(prescription.body, ".o_pivot_table_dialog th", 5);
            await click(prescription.body.querySelector(".o_missing_value"));
