    ...
    steps: () => [
        ...
        },
        {
            ...
            run: function (actions) {
                const pivots = prescription.querySelectorAll("div.pivot_filter");
        ...
        },
        {
            ...
            run: function () {
                const defaultFilterValue = prescription.querySelectorAll(
                    'div.o_multi_record_selector span.badge[title="Azure Interior"]'
                );
                assert(
                ...
                assert(
                    prescription.querySelector(".o_side_panel_related_model input").value,
                    "Contact",
                    "Wrong model selected"
                );

                const fieldsValue = prescription.querySelector(
        ...
        },
        {
            ...
            content: "Sheet is visible in Prescriptions",
            isCheck: true,
        },
    ],
});
