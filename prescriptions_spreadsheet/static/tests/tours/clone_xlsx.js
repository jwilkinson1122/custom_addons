...
registry.category("web_tour.tours").add("spreadsheet_clone_xlsx", {
    ...
    steps: () => [
        ...
        {
            trigger: ".o_kanban_renderer .o_kanban_record:first:has('.o_prescription_spreadsheet')",
            content: "Check a spreadsheet prescription was created",
            isCheck: true,
        },
        {
            trigger: ".o_prescription_xlsx",
        ...
        {
            trigger: ".o_kanban_renderer:not(:has(.o_kanban_record .o_prescription_xlsx))",
        ...
        {
            trigger: ".o_prescription_xlsx",
            content: "Select xlsx prescription",
        },
        {
            trigger: ".modal-footer .btn-primary",
            content: "Restore xlsx prescription",
        },
        {
