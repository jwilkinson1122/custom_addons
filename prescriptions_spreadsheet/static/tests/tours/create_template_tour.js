...
registry.category("web_tour.tours").add(
    "prescriptions_spreadsheet_create_template_tour",
    {
        test: true,
        url: "/web",
        steps: () => [
        ...stepUtils.goToAppSteps("prescriptions.menu_root", "Open Prescription app"),
        {
        ...
        {
            trigger: 'button[data-menu-xmlid="prescriptions.Config"]',
            content: "Open Configuration menu",
            run: "click",
        },
        {
            trigger:
                '.dropdown-item[data-menu-xmlid="prescriptions_spreadsheet.menu_technical_spreadsheet_template"]',
