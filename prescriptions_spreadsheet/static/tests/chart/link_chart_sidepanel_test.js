...
QUnit.module(
    "prescriptions_spreadsheet > ir.ui.menu chart ui",
    {
        beforeEach: function () {
            target = getFixture();
            this.serverData = {};
            this.serverData.menus = {
                ...
                3: {
                    ...
                    children: [1, 2],
                    name: "MyApp",
                    xmlid: "prescriptions_spreadsheet.test.app",
                    appID: 3,
                    actionID: "menuAction",
                },
                1: {
                    ...
                    children: [],
                    name: "test menu 1",
                    xmlid: "prescriptions_spreadsheet.test.menu",
                    appID: 3,
                    actionID: "menuAction",
                },
                2: {
                    ...
                    children: [],
                    name: "test menu 2",
                    xmlid: "prescriptions_spreadsheet.test.menu2",
                    appID: 3,
    ...
    () => {
        QUnit.test(
            ...
            async function (assert) {
                ...
                assert.equal(
                    odooMenu.xmlid,
                    "prescriptions_spreadsheet.test.menu",
        ...
        QUnit.test(
            ...
            async function (assert) {
                ...
                model.dispatch("LINK_ODOO_MENU_TO_CHART", {
                    chartId,
                    odooMenuId: "prescriptions_spreadsheet.test.menu",
                });
                await openChartSidePanel();
                await nextTick();
                const irMenuField = target.querySelector(".o-ir-menu-selector input");
