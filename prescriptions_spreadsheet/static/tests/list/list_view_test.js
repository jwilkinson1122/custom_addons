...
QUnit.module("prescription_spreadsheet > list view", {}, () => {
    ...
    QUnit.test("Re-insert a list correctly ask for lines number", async function (assert) {
        ...
        const input = prescription.body.querySelector(".modal-body input");
        assert.ok(input);
    ...
    QUnit.test("Update the list title from the side panel", async function (assert) {
        ...
        await nextTick();
        await click(prescription.body.querySelector(".o_sp_en_rename"));
        await editInput(prescription, ".o_sp_en_name", "new name");
        await click(prescription.body.querySelector(".o_sp_en_save"));
