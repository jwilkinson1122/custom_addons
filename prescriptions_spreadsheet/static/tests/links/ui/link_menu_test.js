...
QUnit.module("spreadsheet > menu link ui", { beforeEach }, () => {
    QUnit.test("insert a new ir menu link", async function (assert) {
        ...
        await click(prescription.querySelectorAll(".ui-menu-item")[0]);
        await click(prescription, "button.o-confirm");
    ...
    QUnit.test("update selected ir menu", async function (assert) {
        ...
        await click(target, ".o-ir-menu-selector input");
        assert.ok(target.querySelector("button.o-confirm").disabled);
        const item1 = prescription.querySelectorAll(".ui-menu-item")[1];
        ...
        await click(target, ".o-ir-menu-selector input");
        const item2 = prescription.querySelectorAll(".ui-menu-item")[0];
    ...
    QUnit.test(
        ...
        async function (assert) {
            ...
            await click(target, ".o-ir-menu-selector input");
            assert.ok(target.querySelector("button.o-confirm").disabled);
            const item = prescription.querySelectorAll(".ui-menu-item")[1];
    ...
    QUnit.test("ir.menu link keep breadcrumb", async function (assert) {
        ...
        await nextTick();
        const link = prescription.querySelector("a.o-link");
        await click(link);
        assert.strictEqual(
