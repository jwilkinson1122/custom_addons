...
class podiatry_patient_evaluation(models.Model):
    ...
    urgency = fields.Selection(
        [('a', 'Normal'), ('b', 'Urgent'), ('c', 'Podiatry Emergency')], string='Urgency')
    ...
    podiatry_appointment_date_id = fields.Many2one(
        'podiatry.appointment', 'Appointment Date')
    next_appointment_id = fields.Many2one(
        'podiatry.appointment', 'Next Appointment')
    ...
    diagnostic_hypothesis_ids = fields.One2many(
        'podiatry.diagnostic_hypotesis', 'patient_evaluation_id', 'Procedures')
    procedure_ids = fields.One2many(
        'podiatry.directions', 'patient_evaluation_id', 'Procedures')
