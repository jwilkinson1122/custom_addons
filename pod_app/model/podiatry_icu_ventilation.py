...
class podiatry_icu_ventilation(models.Model):
    _name = 'podiatry.icu.ventilation'
    _description = 'Podiatry Icu ventilation'
    ...
    ventilation = fields.Selection([('none', 'None - Maintains Own'), ('nppv', 'Non-Invasive Psitive Pressure'),
                                   ('ett', 'ETT'), ('tracheostomy', 'Tracheostomy')], string="Type")
