...
class podiatry_patient_pregnency(models.Model):
    ...
    podiatry_patient_evolution_prental_ids = fields.One2many(
        'podiatry.patient.prental.evoultion', 'pregnency_id', 'Patient Perinatal Evaluations')
    podiatry_perinatal_ids = fields.One2many(
        'podiatry.preinatal', 'pregnency_id', 'Podiatry Perinatal ')
    puerperium_perental_ids = fields.One2many(
        'podiatry.puerperium.monitor', 'pregnency_id', 'Puerperium Monitor')
