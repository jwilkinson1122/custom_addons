...
class ProductCustomerCode(models.Model):
    ...
    def default_get(self, fields_list):
        res = super(ProductCustomerCode, self).default_get(fields_list)
    ...
    product_name = fields.Char(
        ...
        help="This product name will be used when printing a request for quotation. Keep empty to use the internal one.")
    product_code = fields.Char(
        'Customer Product Code',
        help="This product code will be used when printing a request for quotation. Keep empty to use the internal one.")
