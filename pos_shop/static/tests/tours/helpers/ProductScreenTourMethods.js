...
export function clickSplitInvoiceButton() {
    return [
        {
            content: "click split invoice button",
...
export function clickPrintInvoiceButton() {
    return [
        {
            content: "click print invoice button",
            trigger: ".control-buttons .control-button.order-printinvoice",
        },
        {
