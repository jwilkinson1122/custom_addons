...
registry.category("web_tour.tours").add("PosResTicketScreenTour", {
    ...
    steps: () =>
        [
            ...
            // New Ticket button should not be in the ticket screen if no section is selected.
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
            TicketScreen.noNewTicketButton(),
            TicketScreen.clickDiscard(),

            // Deleting the last order in the section brings back to floorscreen
            ...
            // Create 2 items in a section. From floorscreen, delete 1 item. Then select the other item.
            ...
            FloorScreen.orderCountSyncedInSectionIs("2", "3"),
            Chrome.clickMenuButton(),
            Chrome.clickTicketButton(),
