...
patch(TicketScreen.prototype, {
    ...
    async _setOrder(order) {
        if (!this.pos.config.module_pos_shop || this.pos.section || !order.sectionId) {
    ...
    get allowNewOrders() {
        return this.pos.config.module_pos_shop
    ...
    async onDoRefund() {
        ...
        if (this.pos.config.module_pos_shop && order && !this.pos.section) {
...
export class TipCell extends Component {
    static template = "pos_shop.TipCell";
