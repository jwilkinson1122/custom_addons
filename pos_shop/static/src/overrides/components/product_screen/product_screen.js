...
patch(ProductScreen.prototype, {
    ...
    get selectedOrderlineQuantity() {
        ...
        if (this.pos.config.module_pos_shop && this.pos.orderPreparationCategories.size) {
    ...
    get swapButton() {
        return this.pos.config.module_pos_shop && this.pos.orderPreparationCategories.size;
    },
    submitOrder() {
    ...
    get primaryReviewButton() {
        return (
            ...
            this.pos.config.module_pos_shop
        );
    },
