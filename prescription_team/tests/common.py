...
class PrescriptionTeamCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.group_prescription_personnel = cls.env.ref('prescription_team.group_prescription_personnel')
...
class TestPrescriptionCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.user_prescription_leads = mail_new_test_user(
            ...
            company_id=cls.company_main.id,
            notification_type='inbox',
            groups='prescription_team.group_prescription_personnel_all_leads,base.group_partner_manager',
        )
        cls.user_prescription_personnel = mail_new_test_user(
            ...
            company_id=cls.company_main.id,
            notification_type='inbox',
            groups='prescription_team.group_prescription_personnel',
        )
