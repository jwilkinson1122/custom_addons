...
class CrmTeamMember(models.Model):
    ...
    user_id = fields.Many2one(
        'res.users', string='Prescriptionperson',  # TDE FIXME check responsible field
        check_company=True, index=True, ondelete='cascade', required=True,
    ...
    def create(self, values_list):
        ...
        (tracked fields).
        """
        is_membership_multi = self.env['ir.config_parameter'].sudo().get_param('prescription_team.membership_multi', False)
