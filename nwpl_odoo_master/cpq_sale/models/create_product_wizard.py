...
from ...cpq.helpers.summary_helper import get_cpq_config_dict

class CreateProductWizard(models.TransientModel):
    _name = "create.product.wizard"
    _description = "Confirm Product Creation from Custom Configuration"
    ...
    def default_get(self, fields_list):
        ...
        if not config:
            return res  # or raise ValidationError("Invalid Custom configuration data.")
