...
class OdooFileSystem(RootedDirFileSystem):
    ...
    Parameters:
        odoo_storage_path: The path of the subdirectory of the Odoo filestore
            ...
            by the Odoo File Storage even if it is explicitly defined in the
            storage options.
        file: AbstractFileSystem
            An instantiated filesystem to wrap.
        target_protocol, target_options:
            if file is none, construct it from these
    """
...
register_implementation("odoofile", OdooFileSystem)
