...
class ConfigurationWizard(ProductConfiguratorTestCases):
    def setUp(self):
        ...
        self.attr_line_fuel = self.env.ref(
            "nwpl_odoo_master.ptal_superglass_flex_fuel_types"
        )
        ...
        self.value_218d = self.env.ref(
            "nwpl_odoo_master.pav_engine_218d"
        )
        self.value_220d = self.env.ref(
            "nwpl_odoo_master.pav_engine_220d"
        )
        ...
        self.config_step_body = self.env.ref("nwpl_odoo_master.config_step_body")
        ...
        self.cfg_tmpl = self.env.ref("nwpl_odoo_master.product_template_superglass_flex")
