...
class Repair(models.Model):
        ...
        for available_qty in [available_qty_owner, available_qty_noown]:
            ...
            return {
                ...
                "view_id": self.env.ref(
                    "nwpl_odoo_master.stock_warn_insufficient_qty_repair_form_view"
                ).id,
    ...
    def action_send_mail(self):
        self.ensure_one()
        template_id = self.env.ref("nwpl_odoo_master.mail_template_repair_quotation").id
        ctx = {
    ...
    def print_repair_order(self):
        return self.env.ref(
            "nwpl_odoo_master.action_report_repair_order"
        ).report_action(self)
