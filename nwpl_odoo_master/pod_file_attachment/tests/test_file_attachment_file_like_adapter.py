...
class TestFileAttachmentFileLikeAdapterMixin:
    @classmethod
...
class TestAttachmentInFileSystemFileLikeAdapter(
    TestFileAttachmentCommon, TestFileAttachmentFileLikeAdapterMixin
):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
...
class TestAttachmentInFileLikeAdapter(
    TestFileAttachmentCommon, TestFileAttachmentFileLikeAdapterMixin
):
    @classmethod
    def setUpClass(cls):
...
class TestAttachmentInFileSystemDependingModelFileLikeAdapter(
    ...
    def test_storage_location(self):
        self.assertEqual(self.attachment.file_storage_id, self.temp_backend)
