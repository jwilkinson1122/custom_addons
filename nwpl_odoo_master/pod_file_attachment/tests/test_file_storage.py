...
from .common import TestFileAttachmentCommon


class TestFileStorage(TestFileAttachmentCommon):
    @classmethod
    def setUpClass(cls):
        res = super().setUpClass()
        cls.default_backend = cls.env.ref("nwpl_odoo_master.default_file_storage")
        return res
    ...
    def test_constraint_unique_storage_model(self):
        ...
        self.env.ref("nwpl_odoo_master.default_file_storage")
    ...
    def test_force_model_create_attachment(self):
        ...
        Use odoofile as default for attachments
        ...
        * Check that updating this first attachment does not change the storage
        ...
        self.assertEqual(attachment.file_storage_code, self.temp_backend.code)
        ...
        self.assertEqual(attachment.file_storage_code, self.default_backend.code)
    ...
    def test_force_field_and_model_create_attachment(self):
        ...
        * Check that updating this first attachment does not change the storage
        ...
        self.assertFalse(attachment.file_storage_code)
    ...
    def test_recompute_urls(self):
        ...
        * Check that after updating the base_url for the backend, executing recompute_urls
        updates file_url for both attachments, whether they are linked to a field or not
        """
        ...
        self.env.cr.execute(
            ...
            SELECT COUNT(*)
            FROM ir_attachment
            WHERE file_storage_id = {self.temp_backend.id}
                AND file_url LIKE '{self.temp_backend.base_url}%'
        """
        )
