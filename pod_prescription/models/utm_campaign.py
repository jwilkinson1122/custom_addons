...
class UtmCampaign(models.Model):
    ...
    quotation_count = fields.Integer('Draft Rx Count',
        compute="_compute_quotation_count", compute_sudo=True, groups='pod_prescription_team.group_prescription_personnel')
    invoiced_amount = fields.Integer(string="Revenues generated by the campaign",
        compute="_compute_prescription_invoiced_amount", compute_sudo=True, groups='pod_prescription_team.group_prescription_personnel')
    company_id = fields.Many2one('res.company', string='Company', default=lambda self: self.env.company)
    currency_id = fields.Many2one('res.currency', related='company_id.currency_id', string='Currency')

    def _compute_quotation_count(self):
        quotation_data = self.env['prescription.order']._read_group([
    ...
    def _compute_prescription_invoiced_amount(self):
    ...
    def action_redirect_to_quotations(self):
        action = self.env["ir.actions.actions"]._for_xml_id("pod_prescription.action_quotations_with_onboarding")
