...
registry.category("web_tour.tours").add("prescription_tour", {
    ...
    extra_trigger: ".o_prescription_order",
...
}, stepUtils.showAppsMenuItem(),
{
    ...
    trigger: 'a.o_onboarding_step_action.btn[data-method=action_open_step_prescription_order_confirmation]',
    extra_trigger: ".o_prescription_order",
    content: _t("To speed up order confirmation, we can activate electronic signatures or payments."),
    position: "bottom",
    skip_trigger: 'a[data-method=action_open_step_prescription_order_confirmation].o_onboarding_step_action__done',
}, {
...
registry.category("web_tour.tours").add("prescription_quote_tour", {
        url: "/web#action=pod_prescription.action_quotations_with_onboarding&view_type=form",
        rainbowMan: true,
