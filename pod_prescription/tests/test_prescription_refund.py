...
class TestPrescriptionRefund(TestPrescriptionCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.invoice = cls.prescription_order.invoice_ids[0]
    ...
    def test_refund_create(self):
        ...
        invoice_refund = self.prescription_order.invoice_ids.sorted(key=lambda inv: inv.id, reverse=False)[-1]  # the first invoice, its refund, and the new invoice
    ...
    def test_refund_invoice_with_downpayment(self):
        prescription_order_refund = self.env['prescription.order'].create({
