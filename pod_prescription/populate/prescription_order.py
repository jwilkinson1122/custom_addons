...
class PrescriptionOrder(models.Model):
    ...
    def _populate_factories(self):
        ...
        def get_company_info(iterator, field_name, model_name):
            random = populate.Random("prescription_order_company")
...
class PrescriptionOrderLine(models.Model):
    ...
    @classmethod
    def filter_confirmable_prescription_orders(cls, prescription_order):
        return prescription_order

    def _populate_factories(self):
        order_ids = self.env.registry.populated_models["prescription.order"]
