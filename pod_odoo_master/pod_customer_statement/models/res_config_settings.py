...
class ResCompany(models.Model):
    ...
    customer_statement_auto_send = fields.Boolean("Customer Statement Auto Send")
    filter_only_unpaid_and_send_that = fields.Boolean(
        string="Filter Only Unpaid, Send nothing if all invoices are paid"
    )
    ...
    cust_create_log_history = fields.Boolean("Customer Statement Mail Log History")
    ...
    display_customer_statement = fields.Boolean(
        "Show Customer Statement Menu in portal ?"
    )
    display_due_statement = fields.Selection(
        [("due", "Only Due"), ("overdue", "Only Overdue"), ("both", "Both")],
    ...
    display_message_in_chatter = fields.Boolean(
        "Display in Chatter Message?", default=False
    )
    statement_pdf_in_message = fields.Boolean(
        "Send Report URL in Message?", default=True
    )
    statement_url_in_message = fields.Boolean(
        "Send Statement URL in Message?", default=True
    )
...
class ResConfigSetting(models.TransientModel):
    ...
    customer_statement_auto_send = fields.Boolean(
        ...
        related="company_id.customer_statement_auto_send",
        readonly=False,
    )
    filter_only_unpaid_and_send_that = fields.Boolean(
        string="Filter Only Unpaid, Send nothing if all invoices are paid",
        related="company_id.filter_only_unpaid_and_send_that",
        readonly=False,
    )

    customer_statement_action = fields.Selection(
        related="company_id.customer_statement_action",
        string="Customer Statement Action",
        readonly=False,
    )
    cus_daily_statement_template_id = fields.Many2one(
        "mail.template",
        string="  Daily Mail Template",
        related="company_id.cus_daily_statement_template_id",
        readonly=False,
    )
    cust_week_day = fields.Selection(
    ...
    cust_weekly_statement_template_id = fields.Many2one(
        "mail.template",
        string="Weekly Mail Template   ",
        related="company_id.cust_weekly_statement_template_id",
        readonly=False,
    )
    cust_monthly_date = fields.Integer(
        "Monthly  Day",
        related="company_id.cust_monthly_date",
        readonly=False,
        default=1,
    )
    cust_monthly_template_id = fields.Many2one(
        "mail.template",
        string="Monthly Mail Template",
        related="company_id.cust_monthly_template_id",
        readonly=False,
    )
    cust_yearly_date = fields.Integer(
        " Yearly day ",
        related="company_id.cust_yearly_date",
        readonly=False,
        default=1,
    )
    ...
    cust_yearly_template_id = fields.Many2one(
        "mail.template",
        string="  Yearly Mail Template",
        related="company_id.cust_yearly_template_id",
        readonly=False,
    )
    cust_create_log_history = fields.Boolean(
        "Customer Statement Mail Log History",
        related="company_id.cust_create_log_history",
        readonly=False,
    )

    customer_due_statement_auto_send = fields.Boolean(
        "Customer Overdue Statement Auto Send",
        related="company_id.customer_due_statement_auto_send",
        readonly=False,
    )
    customer_due_statement_action = fields.Selection(
        related="company_id.customer_due_statement_action",
        string="Customer Overdue Statement Action",
        readonly=False,
    )
    cus_due_daily_statement_template_id = fields.Many2one(
        "mail.template",
        string=" Daily Mail Template",
        related="company_id.cus_due_daily_statement_template_id",
        readonly=False,
    )
    cust_due_week_day = fields.Selection(
    ...
    cust_due_weekly_statement_template_id = fields.Many2one(
        "mail.template",
        string="   Weekly Mail Template",
        related="company_id.cust_due_weekly_statement_template_id",
        readonly=False,
    )
    cust_due_monthly_date = fields.Integer(
        "Monthly Day    ",
        related="company_id.cust_due_monthly_date",
        readonly=False,
        default=1,
    )
    ...
    cust_due_monthly_template_id = fields.Many2one(
        "mail.template",
        string="Monthly  Mail Template",
        related="company_id.cust_due_monthly_template_id",
        readonly=False,
    )
    cust_due_yearly_date = fields.Integer(
        "  Yearly Day     ",
        related="company_id.cust_due_yearly_date",
        readonly=False,
        default=1,
    )
    cust_due_yearly_month = fields.Selection(
    ...
    cust_due_yearly_template_id = fields.Many2one(
        "mail.template",
        string=" Yearly Mail Template",
        related="company_id.cust_due_yearly_template_id",
        readonly=False,
    )
    cust_due_create_log_history = fields.Boolean(
        "Customer Overdue Statement Mail Log History",
        related="company_id.cust_due_create_log_history",
        readonly=False,
    )
    ...
    statement_signature = fields.Boolean(
        "Signature?", related="company_id.statement_signature", readonly=False
    )
    display_message_in_chatter = fields.Boolean(
        "Display in Chatter Message?",
        related="company_id.display_message_in_chatter",
        readonly=False,
    )
    statement_pdf_in_message = fields.Boolean(
        "Send Report URL in Message?",
        related="company_id.statement_pdf_in_message",
        readonly=False,
    )
    statement_url_in_message = fields.Boolean(
        "Send Statement URL in Message?",
        related="company_id.statement_url_in_message",
        readonly=False,
    )
