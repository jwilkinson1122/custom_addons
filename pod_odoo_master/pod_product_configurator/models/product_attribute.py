...
class ProductAttributeLine(models.Model):
    ...
    def onchange_attribute(self):
        ...
        self.custom = self.attribute_id.custom
    ...
    # multi = fields.Boolean(help="Allow selection of multiple values for this attribute?")
    

    custom = fields.Boolean(string="Custom", help="Allows custom attribute selection per product")
    multi = fields.Boolean(string="Multi", help="Allows multiple values per attribute")
