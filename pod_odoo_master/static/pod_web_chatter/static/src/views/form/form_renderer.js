...
patch(FormRenderer.prototype, {
    setup() {
        ...
        this.chatterState = useState({
            width: browser.localStorage.getItem('pod_web_chatter.width'),
        });
    ...
    onStartChatterResize(ev) {
        ...
        const resizePanel = (ev) => {
            ...
            browser.localStorage.setItem('pod_web_chatter.width', newWidth);
    ...
    onDoubleClickChatterResize(ev) {
    	browser.localStorage.removeItem('pod_web_chatter.width');
