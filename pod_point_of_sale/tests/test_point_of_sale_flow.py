...
from odoo.addons.pod_point_of_sale.tests.common import TestPointOfSaleCommon
...
class TestPointOfSaleFlow(TestPointOfSaleCommon):
    ...
    def test_create_from_ui(self):
        ...
        with mute_logger('odoo.addons.pod_point_of_sale.models.pos_order'):
    ...
    def test_order_total_subtotal_account_line_values(self):
        ...
        pos_user = self.env['res.users'].create({
            ...
            'groups_id': [(6, 0, [self.ref('base.group_user'), self.ref('pod_point_of_sale.group_pos_user')])],
        })
