 ...
 *
 * import { PaymentInterface } from "@pod_point_of_sale/app/payment/payment_interface";
 * class MyPayment extends PaymentInterface {}
 *
 * To connect the interface to the right payment methods register it:
 *
 * import { register_payment_method } models from "@pod_point_of_sale/app/store/pos_store";
