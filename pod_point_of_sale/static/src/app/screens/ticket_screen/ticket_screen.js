...
import { Order } from "@pod_point_of_sale/app/store/models";
...
import { ConfirmPopup } from "@pod_point_of_sale/app/utils/confirm_popup/confirm_popup";

import { ActionpadWidget } from "@pod_point_of_sale/app/screens/product_screen/action_pad/action_pad";
import { InvoiceButton } from "@pod_point_of_sale/app/screens/ticket_screen/invoice_button/invoice_button";
...
import { CenteredIcon } from "@pod_point_of_sale/app/generic_components/centered_icon/centered_icon";
import { ReprintReceiptButton } from "@pod_point_of_sale/app/screens/ticket_screen/reprint_receipt_button/reprint_receipt_button";
import { SearchBar } from "@pod_point_of_sale/app/screens/ticket_screen/search_bar/search_bar";
...
export class TicketScreen extends Component {
    ...
    static template = "pod_point_of_sale.TicketScreen";
    static components = {
        ActionpadWidget,
        InvoiceButton,
        Orderline,
