...
import { ProductCard } from "@pod_point_of_sale/app/generic_components/product_card/product_card";
import { Component, useState, useEffect, useRef } from "@odoo/owl";
import { OfflineErrorPopup } from "@pod_point_of_sale/app/errors/popups/offline_error_popup";
import { ErrorPopup } from "@pod_point_of_sale/app/errors/popups/error_popup";
import { ProductInfoPopup } from "@pod_point_of_sale/app/screens/product_screen/product_info_popup/product_info_popup";
import { CategorySelector } from "@pod_point_of_sale/app/generic_components/category_selector/category_selector";
import { Input } from "@pod_point_of_sale/app/generic_components/inputs/input/input";

export class ProductsWidget extends Component {
    static components = { ProductCard, CategorySelector, Input };
    static template = "pod_point_of_sale.ProductsWidget";
    setup() {
        this.state = useState({
            previousSearchWord: "",
            currentOffset: 0,
    ...
    /**
     * @returns {import("@pod_point_of_sale/app/generic_components/category_selector/category_selector").Category[]}
     */
    getCategories() {
        return [
    ...
    createNewProducts() {
        window.open("/web#action=pod_point_of_sale.action_client_product_menu", "_self");
    }
