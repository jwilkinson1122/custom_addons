...
import { ControlButtonsMixin } from "@pod_point_of_sale/app/utils/control_buttons_mixin";
import { registry } from "@web/core/registry";
import { useService } from "@web/core/utils/hooks";
import { useBarcodeReader } from "@pod_point_of_sale/app/barcode/barcode_reader_hook";
import { parseFloat } from "@web/views/fields/parsers";
import { _t } from "@web/core/l10n/translation";

import { NumberPopup } from "@pod_point_of_sale/app/utils/input_popups/number_popup";
import { ErrorPopup } from "@pod_point_of_sale/app/errors/popups/error_popup";
import { ControlButtonPopup } from "@pod_point_of_sale/app/screens/product_screen/control_buttons/control_buttons_popup";
import { ConnectionLostError } from "@web/core/network/rpc_service";

import { usePos } from "@pod_point_of_sale/app/store/pos_hook";
import { Component, onMounted, useExternalListener, useState } from "@odoo/owl";
import { ErrorBarcodePopup } from "@pod_point_of_sale/app/barcode/error_popup/barcode_error_popup";

import { Numpad } from "@pod_point_of_sale/app/generic_components/numpad/numpad";
import { ProductsWidget } from "@pod_point_of_sale/app/screens/product_screen/product_list/product_list";
import { ActionpadWidget } from "@pod_point_of_sale/app/screens/product_screen/action_pad/action_pad";
import { Orderline } from "@pod_point_of_sale/app/generic_components/orderline/orderline";
import { OrderWidget } from "@pod_point_of_sale/app/generic_components/order_widget/order_widget";
export class ProductScreen extends ControlButtonsMixin(Component) {
    static template = "pod_point_of_sale.ProductScreen";
    static components = {
        ActionpadWidget,
        Numpad,
        ProductsWidget,
