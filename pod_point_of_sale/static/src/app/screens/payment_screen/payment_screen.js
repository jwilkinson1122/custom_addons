...
import { useErrorHandlers, useAsyncLockedMethod } from "@pod_point_of_sale/app/utils/hooks";
...
import { DatePickerPopup } from "@pod_point_of_sale/app/utils/date_picker_popup/date_picker_popup";
import { ConfirmPopup } from "@pod_point_of_sale/app/utils/confirm_popup/confirm_popup";
import { ConnectionLostError } from "@web/core/network/rpc_service";

import { PaymentScreenPaymentLines } from "@pod_point_of_sale/app/screens/payment_screen/payment_lines/payment_lines";
import { PaymentScreenStatus } from "@pod_point_of_sale/app/screens/payment_screen/payment_status/payment_status";
...
import { OrderReceipt } from "@pod_point_of_sale/app/screens/receipt_screen/receipt/order_receipt";

export class PaymentScreen extends Component {
    static template = "pod_point_of_sale.PaymentScreen";
    static components = {
        Numpad,
    ...
    paymentMethodImage(id) {
        if (this.paymentMethod.image) {
            ...
            return "/pod_point_of_sale/static/src/img/money.png";
        } else if (this.paymentMethod.type === "pay_later") {
            return "/pod_point_of_sale/static/src/img/pay-later.png";
        } else {
            return "/pod_point_of_sale/static/src/img/card-bank.png";
        }
    }
