...
import { PosCollection, Order, Product } from "@pod_point_of_sale/app/store/models";
import { Mutex } from "@web/core/utils/concurrency";
import { PosDB } from "@pod_point_of_sale/app/store/db";
...
import { deduceUrl } from "@pod_point_of_sale/utils";
import { Reactive } from "@web/core/utils/reactive";
import { HWPrinter } from "@pod_point_of_sale/app/printer/hw_printer";
import { memoize } from "@web/core/utils/functions";
import { ErrorPopup } from "@pod_point_of_sale/app/errors/popups/error_popup";
import { ConnectionLostError } from "@web/core/network/rpc_service";
import { _t } from "@web/core/l10n/translation";
import { CashOpeningPopup } from "@pod_point_of_sale/app/store/cash_opening_popup/cash_opening_popup";
import { PaymentScreen } from "@pod_point_of_sale/app/screens/payment_screen/payment_screen";
...
export class PosStore extends Reactive {
    ...
    async customerDisplayHTML(closeUI = false) {
        const order = this.get_order();
        if (closeUI || !order) {
            return renderToString("pod_point_of_sale.CustomerFacingDisplayNoOrder", {
                pos: this,
        ...
        return renderToString("pod_point_of_sale.CustomerFacingDisplayOrder", {
            pos: this,
    ...
    async closePos() {
        ...
        if (!this || this.db.get_orders().length === 0) {
            window.location = "/web#action=pod_point_of_sale.action_client_pos_menu";
        }
