...
import { random5Chars, uuidv4, qrCodeSrc, constructFullProductName } from "@pod_point_of_sale/utils";
...
import { ProductConfiguratorPopup } from "@pod_point_of_sale/app/store/product_configurator_popup/product_configurator_popup";
    ...
    async printChanges(cancelled) {
        ...
        for (const printer of this.pos.unwatched.printers) {
            ...
            if (changes["new"].length > 0 || changes["cancelled"].length > 0) {
                ...
                const receipt = renderToElement("pod_point_of_sale.OrderChangeReceipt", {
