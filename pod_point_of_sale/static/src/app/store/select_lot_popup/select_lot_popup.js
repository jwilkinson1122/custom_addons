...
import { useAutoFocusToLast } from "@pod_point_of_sale/app/utils/hooks";
import { _t } from "@web/core/l10n/translation";
import { useState } from "@odoo/owl";
import { EditListInput } from "@pod_point_of_sale/app/store/select_lot_popup/edit_list_input/edit_list_input";
...
export class EditListPopup extends AbstractAwaitablePopup {
    ...
    static template = "pod_point_of_sale.EditListPopup";
    static defaultProps = {
        confirmText: _t("Add"),
