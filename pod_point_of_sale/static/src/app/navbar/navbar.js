...
import { CashierName } from "@pod_point_of_sale/app/navbar/cashier_name/cashier_name";
import { CustomerFacingDisplayButton } from "@pod_point_of_sale/app/navbar/customer_facing_display_button/customer_facing_display_button";
import { ProxyStatus } from "@pod_point_of_sale/app/navbar/proxy_status/proxy_status";
import { SaleDetailsButton } from "@pod_point_of_sale/app/navbar/sale_details_button/sale_details_button";
import { SyncNotification } from "@pod_point_of_sale/app/navbar/sync_notification/sync_notification";
import { CashMovePopup } from "@pod_point_of_sale/app/navbar/cash_move_popup/cash_move_popup";
import { TicketScreen } from "@pod_point_of_sale/app/screens/ticket_screen/ticket_screen";
import { BackButton } from "@pod_point_of_sale/app/navbar/back_button/back_button";
import { Component, useState, useExternalListener } from "@odoo/owl";
import { ClosePosPopup } from "@pod_point_of_sale/app/navbar/closing_popup/closing_popup";
import { _t } from "@web/core/l10n/translation";
import { ProductScreen } from "@pod_point_of_sale/app/screens/product_screen/product_screen";

export class Navbar extends Component {
    static template = "pod_point_of_sale.Navbar";
    static components = {
