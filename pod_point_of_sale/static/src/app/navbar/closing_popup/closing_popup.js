...
import { MoneyDetailsPopup } from "@pod_point_of_sale/app/utils/money_details_popup/money_details_popup";
...
import { useAsyncLockedMethod } from "@pod_point_of_sale/app/utils/hooks";

export class ClosePosPopup extends AbstractAwaitablePopup {
    static components = { SaleDetailsButton, Input };
    static template = "pod_point_of_sale.ClosePosPopup";
    static props = [
        "orders_details",
        "opening_notes",
    ...
    async downloadSalesReport() {
        return this.report.doAction("pod_point_of_sale.sale_details_report", [
