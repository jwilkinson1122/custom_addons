...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'pod_point_of_sale/static/src/backend/tours/pod_point_of_sale.js',
            'pod_point_of_sale/static/src/backend/debug_manager.js',
        ],
        'web.assets_tests': [
            'pod_point_of_sale/static/tests/tours/**/*',
        ],
        ...
        'pod_point_of_sale._assets_pos': [
            ...
            # 'pod_point_of_sale/static/src/scss/primary_variables.scss', TO DO - CREATE
            ...
            'pod_point_of_sale/static/src/scss/pos_variables_extra.scss',
            ...
            # PoS files
            'pod_point_of_sale/static/src/**/*',
            ('remove', 'pod_point_of_sale/static/src/backend/**/*'),
            # main.js boots the pos app, it is only included in the prod bundle as tests mount the app themselves
            ('remove', 'pod_point_of_sale/static/src/app/main.js'),
        ...
        'pod_point_of_sale.assets_prod': [
            ('include', 'pod_point_of_sale._assets_pos'),
            'pod_point_of_sale/static/src/app/main.js',
        ],
        # Bundle for the unit tests at /pos/ui/tests
        'pod_point_of_sale.assets_qunit_tests': [
            ('include', 'pod_point_of_sale._assets_pos'),
            ...
            # pos unit tests
            'pod_point_of_sale/static/tests/unit/**/*',
        ],
    },
    'license': 'LGPL-3',
}
