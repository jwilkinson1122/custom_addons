...
class PosController(PortalAccount):
    ...
    def pos_web(self, config_id=False, **k):
        ...
        if not pos_session or config_id and not pos_config.active:
            return request.redirect('/web#action=pod_point_of_sale.action_client_pos_menu')
        ...
        response = request.render('pod_point_of_sale.index', context)
    ...
    def test_suite(self, mod=None, **kwargs):
        ...
        return request.render('pod_point_of_sale.qunit_suite', qcontext=context)

    @http.route('/pos/sale_details_report', type='http', auth='user')
    def print_sale_details(self, date_start=False, date_stop=False, **kw):
        r = request.env['report.pod_point_of_sale.report_saledetails']
        pdf, _ = request.env['ir.actions.report'].with_context(date_start=date_start, date_stop=date_stop)._render_qweb_pdf('pod_point_of_sale.sale_details_report', r)
    ...
    def invoice_request_screen(self, **kwargs):
        ...
        return request.render("pod_point_of_sale.ticket_request_with_code", {
            'errors': errors,
    ...
    def show_ticket_validation_screen(self, access_token='', **kwargs):
        ...
        return request.render("pod_point_of_sale.ticket_validation_screen", {
            'partner': partner,
