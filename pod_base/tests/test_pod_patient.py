...
MOCK_PATH = 'odoo.addons.pod_base.models.pod.patient.date'
...
class TestPatient(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patient_1 = self.env.ref(
            'pod_base.pod.patient_patient_1')
        self.partner_patient_1 = self.env.\
            ref('pod_base.res_partner_patient_1')
        self.patient_3 = self.env.ref(
            'pod_base.pod.patient_patient_3')
    ...
    def test_search_age(self):
        ...
        result = self.env['pod.patient'].search(
            [('age', '=', years)]
        )
    ...
    def test_search_age_on_birthday(self, date_mock):
        ...
        result = self.env['pod.patient'].search([('age', '=', 1)])
        self.assertIn(self.patient_1, result)
