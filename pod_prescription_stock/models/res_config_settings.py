...
class ResConfigSettings(models.TransientModel):
    ...
    use_security_lead = fields.Boolean(
        string="Security Lead Time for Prescriptions",
        config_parameter='pod_prescriptions_stock.use_security_lead',
    ...
    default_picking_policy = fields.Selection([
        ...
        ], "Picking Policy", default='direct', default_model="prescriptions.order", required=True)
