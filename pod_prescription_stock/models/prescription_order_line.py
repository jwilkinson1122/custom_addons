...
class PrescriptionOrderLine(models.Model):
    ...
    def _compute_qty_delivered(self):
        super(PrescriptionOrderLine, self)._compute_qty_delivered()
    ...
    def write(self, values):
        ...
        res = super(PrescriptionOrderLine, self).write(values)
        if lines:
    ...
    def _update_line_quantity(self, values):
        ...
        super(PrescriptionOrderLine, self)._update_line_quantity(values)
