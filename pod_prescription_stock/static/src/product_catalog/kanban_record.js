...
import { ProductCatalogPrescriptionOrderLine } from "./prescriptions_order_line/prescriptions_order_line";
import { patch } from "@web/core/utils/patch";

patch(ProductCatalogKanbanRecord.prototype, {
    updateQuantity(quantity) {
        if (this.env.orderResModel !== "prescriptions.order") {
            ...
            // possible, as stated in the pod_prescriptions_stock module, then the user inputs a quantity lower
