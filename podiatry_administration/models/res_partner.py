...
class Partner(models.Model):
    ...
    def create(self, vals):
        ...
        for (
            ...
            identifier,
            definition,
        ) in self._get_podiatry_identifiers():
    ...
    def _get_partner_default_image(self, vals):
        if self._get_default_image_path(vals):
            return self._get_default_podiatry_image(vals)
        return False
    ...
    @api.model
    def _get_default_podiatry_image(self, vals):
        if getattr(
    ...
    def default_podiatry_fields(self):
        return ["is_prescription", "company_type"]
