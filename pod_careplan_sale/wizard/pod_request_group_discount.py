...
class PodiatryRequestGroupDiscount(models.TransientModel):
    ...
    percentage = fields.Float( related="pod_sale_discount_id.percentage", readonly=True
    )
    is_fixed = fields.Boolean( related="pod_sale_discount_id.is_fixed", readonly=True
    )
