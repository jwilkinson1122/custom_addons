            ...
            if (product.addon_ids.length) {
                ...
                for (var item = 0; item < product.addon_ids.length; item++) {
                    ...
                    if (product_obj) {
                        ...
                        $('.addons-table').append(
                            '<tr class="addon-contents row" style="width: 100%;">' +
                            '<td class="addons-item" style="width: 100%; display: flex;" data-addon-id=' + product_obj.id + '> ' +
                            '<div class="addons-product" style="display: inline-block; width: 50%;">' + element + '</div>' +
                            '<div class="button-add-sub"><button class="add-button">+</button><button class="remove-button">-</button></div></td>' +
                            '</tr>');
                    }
                }
            } else {
