...
import { PodSOConfirmPopup } from "@pod_pos_master/static/pod_pos_create_so/app/Popups/pod_so_confirm_popup/pod_so_confirm_popup";


export class CreateSoButton extends Component {
    static template = "pod_pos_create_so.CreateSoButton";
    setup() {
        this.pos = usePos();
            ...
            if (orderlines.length != 0) {
                try {
                    ...
                    if (Orders && Orders.length > 0) { 
                        self.popup.add(PodSOConfirmPopup, {
...
ProductScreen.addControlButton({
    ...
    condition: function () {
        return this.pos.config.pod_display_sale_btn
    },
})
