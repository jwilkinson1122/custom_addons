...
class PodProductTemplate(models.Model):
    ...
    def check_uniqe_name(self):
        for rec in self:
            if self.env.company and self.env.company.pod_multi_barcode_unique:
    ...
    def create(self, vals_list):
        ...
        templates = super(PodProductTemplate, self).create(vals_list)
