...
class PosConfig(models.Model):
    ...
    def pod_add_default_data(self):
        key_list = []
        vals = []
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_shift")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_P")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_control")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_c")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_list.append(temp_key_id.id)
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_G")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_v")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_n")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_escape")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_q")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_d")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_f")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_Insert")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_list.append(temp_key_id.id)
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_delete")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_arrow_up")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_arrow_down")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_Enter")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_e")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_s")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_+")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_F10")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_F2")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
        ...
        key_id = self.env.ref("pod_management_master.pod_keyboard_key_F5")
        temp_key_id = (
            self.env["pod.keyboard.key.temp"].sudo().create({"pod_key_ids": key_id.id})
        )
        key_list.append(temp_key_id.id)
