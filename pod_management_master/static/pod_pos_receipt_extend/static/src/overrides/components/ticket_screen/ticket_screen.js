...
patch(TicketScreen.prototype, {
  onClickOrder(clickedOrder) {
    ...
    //   var self = this;
    //   if ( order.name && (this.pos.config.pod_pos_order_number || this.pos.config.pod_pos_receipt_invoice)) {
    ...
    //         Orders[0] &&
    //         Orders[0]["name"] &&
    //         this.pos.config.pod_pos_order_number
    //       ) {
    ...
    //         this.pos.config.pod_pos_receipt_invoice
    //       ) {
