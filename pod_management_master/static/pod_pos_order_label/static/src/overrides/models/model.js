...
patch(Orderline.prototype, {
    setup(_defaultObj, options) {
        super.setup(...arguments);
        this.is_pod_order_label_demo_product = this.product.pod_order_label_demo_product
    },
    init_from_JSON(json) {
    ...
    getDisplayData() {
        ...
        result['is_pod_order_label_demo_product'] = this.is_pod_order_label_demo_product
