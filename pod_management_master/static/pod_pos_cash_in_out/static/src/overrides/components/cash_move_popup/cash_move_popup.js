...
patch(CashMovePopup.prototype, {
  ...
  async confirm() {
    ...
    await this.orm.call("pod.cash.in.out", "try_cash_in_out", [
    ...
    var data = {
      pod_transaction_type: self.pos.cash_in_out_options,
      pod_amount: parseFloat(amount),
      pod_reason: reason,
    ...
    if (type == "in") {
      data["pod_transaction_type"] = "cash_in";
    } else {
      data["pod_transaction_type"] = "cash_out";
      amount = -amount;
    }
