  /** @odoo-module **/
    ...
    export class RemoveAllItemButton extends Component {
        static template = "pod_management_master.RemoveAllItemButton";
        setup() {
            this.pos = usePos();
        ...
        async onClick() {
            ...
            if (this.pos.get_order() && this.pos.get_order().get_orderlines() && this.pos.get_order().get_orderlines().length > 0) {
                ...
                if(self.pos.config.pod_remove_all_item && self.pos.config.pod_validation_to_remove_all_item){
    ...
    ProductScreen.addControlButton({
        ...
        condition: function () {
            return this.pos.config.pod_remove_all_item
        },
    })
