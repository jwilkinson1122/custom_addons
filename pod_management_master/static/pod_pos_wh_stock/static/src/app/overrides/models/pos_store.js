...
import { ProductQtyPopup } from "@pod_management_master/static/pod_pos_wh_stock/app/popups/product_stock_popup/product_stock_popup";
...
patch(PosStore.prototype, {
    ...
    async showStock(id) {
        ...
        if(stocks && stocks.length){
            if (this.config.pod_display_by == "warehouse") {
