...
export class ProductTemplateAttributeLine extends Component {
    ...
    static template = "podPrescriptionProductConfigurator.ptal";
    static props = {
    ...
    getPTAVTemplate() {
        switch(this.props.attribute.display_type) {
            case 'color':
                return 'podPrescriptionProductConfigurator.ptav-color';
            case 'multi':
                return 'podPrescriptionProductConfigurator.ptav-multi';
            case 'pills':
                return 'podPrescriptionProductConfigurator.ptav-pills';
            case 'radio':
                return 'podPrescriptionProductConfigurator.ptav-radio';
            case 'select':
                return 'podPrescriptionProductConfigurator.ptav-select';
        }
    }
     ...
     * Note: used in `podPrescriptionProductConfigurator.ptav-select`.
     *
