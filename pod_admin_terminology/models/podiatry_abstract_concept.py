...
class PodiatryAbstractConcept(models.AbstractModel):
    ...
    _name = "podiatry.abstract.concept"
    _description = "Podiatry abstract concept"

    code = fields.Char(required=True, index=True)  # Field: code
    name = fields.Char(required=True)  # Field: display
    definition = fields.Char()  # Field: definition
