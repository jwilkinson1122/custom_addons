...
class ProductConfiguratorController(Controller):
    ...
    @route('/pod_product_configurator/get_values', type='json', auth='user')
    ...
    @route('/pod_product_configurator/create_product', type='json', auth='user')
    ...
    @route('/pod_product_configurator/update_combination', type='json', auth='user')
    ...
    @route('/pod_product_configurator/get_optional_products', type='json', auth='user')
