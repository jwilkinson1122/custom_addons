...
class BikeRent(models.Model):
    ...
    bike_description = fields.Html(related='bike_id.description', string='Description', store=True)
    image = fields.Binary(related='bike_id.image_1920', string='Picture', store=True)
