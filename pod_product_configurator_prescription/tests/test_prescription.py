...
class Prescription(TC.ProductConfiguratorTestCases):
    def setUp(self):
        ...
        self.resPartner = self.env.ref("pod_product_configurator_prescription.partner_prescription_1")
    ...
    def test_00_reconfigure_product(self):
        ...
        context = dict(
            default_prescription_order_id=prescription_order_id.id,
        ...
        prescription_order_id.prescription_order_line.reconfigure_product()
        product_tmpl = prescription_order_id.prescription_order_line.product_id.product_tmpl_id
        self.assertEqual(
            product_tmpl.id,
