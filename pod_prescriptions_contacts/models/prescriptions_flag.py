...
class PrescriptionsFlag(models.Model):
    ...
    _name = "prescriptions.flag"
    _description = "Prescriptions Flag"
    _inherit = "prescriptions.abstract"
    ...
    patient_id = fields.Many2one(
        string="Patient",
        comodel_name="prescriptions.patient",
        required=True,
        readonly=True,
        ondelete="restrict",
        index=True,
    ...
    category_id = fields.Many2one("prescriptions.flag.category", required=True)
    ...
    def _get_internal_identifier(self, vals):
        return self.env["ir.sequence"].next_by_code("prescriptions.flag") or "/"
