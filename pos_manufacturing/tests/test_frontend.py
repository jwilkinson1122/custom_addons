...
class TestFrontend(odoo.tests.HttpCase):
    def setUp(self):
        ...
        table_05 = self.env['manufacturing.table'].create({
            'name': '5',
        ...
        table_04 = self.env['manufacturing.table'].create({
            'name': '4',
            'floor_id': main_floor.id,
            'seats': 4,
            'shape': 'square',
        ...
        table_02 = self.env['manufacturing.table'].create({
            'name': '2',
            'floor_id': main_floor.id,
            'seats': 4,
            'position_h': 250,
        ...
        table_01 = self.env['manufacturing.table'].create({
            'name': '1',
        ...
        table_03 = self.env['manufacturing.table'].create({
            'name': '3',
            'floor_id': second_floor.id,
            'seats': 4,
            'position_h': 100,
