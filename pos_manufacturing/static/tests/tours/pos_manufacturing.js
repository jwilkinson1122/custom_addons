...
registry.category("web_tour.tours").add("pos_manufacturing_sync", {
    test: true,
    url: "/pos/ui",
    steps: () =>
        [
...
/* pos_manufacturing_sync_second_login
 *
 * This tour should be run after the first tour is done.
 */
registry.category("web_tour.tours").add("pos_manufacturing_sync_second_login", {
    test: true,
    url: "/pos/ui",
    steps: () =>
        [
