...
patch(TicketScreen.prototype, {
    ...
    async _setOrder(order) {
        if (!this.pos.config.module_pos_manufacturing || this.pos.table || !order.tableId) {
    ...
    async onDoRefund() {
        ...
        if (this.pos.config.module_pos_manufacturing && order && !this.pos.table) {
...
export class TipCell extends Component {
    static template = "pos_manufacturing.TipCell";
