    ...
    def download_customer_filter_statement(
        ...
        **kw
        ...
        return self._show_report(
            ...
            report_ref="pod_customer_statement.action_report_customer_filtered_statement",
            download=download,
        )
    ...
    def download_customer_statement(
        ...
        **kw
        ...
        return self._show_cs_report(
            model=statement_sudo,
            report_type=report_type,
            report_ref="pod_customer_statement.action_report_customer_statement",
            download=download,
        )
    ...
    def download_customer_due_statement(
        ...
        **kw
        ...
        return self._show_cds_report(
            model=statement_sudo,
            report_type=report_type,
            report_ref="pod_customer_statement.action_report_customer_due_statement",
            download=download,
        )
