...
class ResPartner(models.Model):
    ...
    def update_statement_config_manually_(self):
        view =self.env.ref('pod_customer_statement.update_customers_statement_config_wizard')
        return {
            'type': 'ir.actions.act_window',
    ...
    def action_print_customer_statement(self):
        return self.env.ref('pod_customer_statement.action_report_customer_statement').report_action(self)
    ...
    def action_print_customer_due_statement(self):
        return self.env.ref('pod_customer_statement.action_report_customer_due_statement').report_action(self)
    ...
    def action_print_filter_customer_statement(self):
        return self.env.ref('pod_customer_statement.action_report_customer_filtered_statement').report_action(self)
