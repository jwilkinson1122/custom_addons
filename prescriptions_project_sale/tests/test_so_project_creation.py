...
class testSoProjectCreation(TestSaleProjectCommon):
    ...
    def test_template_parent_folder(self):
        ...
        """
        parent_folder = self.env['prescriptions.folder'].create({
            'name': 'Parent Folder',
        })
        template_folder_1, template_folder_2 = self.env['prescriptions.folder'].create([{
        ...
        so1_project_workspace = so1_project.prescriptions_folder_id
        ...
        so2_project_workspace = so2_project.prescriptions_folder_id
        prescriptions_project_folder = self.env.ref('prescriptions_project.prescriptions_project_folder')
        self.assertEqual(so2_project_workspace.parent_folder_id.id, prescriptions_project_folder.id)
        ...
        so3_project_workspace = so3_project.prescriptions_folder_id
    ...
    def test_multiple_templates_same_so(self):
        ...
        parent_template_folder = self.env['prescriptions.folder'].create({
            'name': 'Parent',
        })

        template_folder_1, template_folder_2, template_folder_3 = self.env['prescriptions.folder'].create([{
        ...
        project_1_workspace = project_1.prescriptions_folder_id
        ...
        project_2_workspace = project_2.prescriptions_folder_id
        ...
        project_3_workspace = project_3.prescriptions_folder_id
    ...
    def test_project_template_with_prescriptions_disabled(self):
        template_folder = self.env['prescriptions.folder'].create({
        ...
        self.assertFalse(template_project.use_prescriptions)
        self.assertFalse(product_template.template_folder_id, "Setting a project template with the prescriptions feature disabled should unset the workspace template.")
        ...
        sales_order.action_confirm()
        self.assertFalse(sales_order.project_ids.use_prescriptions, "The generated project should have the prescriptions feature disabled.")
    ...
    def test_workspace_from_project(self):
        ...
        self.env['product.template'].create({
            ...
            'template_folder_id': project_template.prescriptions_folder_id.id,
        })
