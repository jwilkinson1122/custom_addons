odoo.define('podiatry_erp.ClientListScreen', function(require) {
    'use strict';

    const Registries = require('point_of_sale.Registries');
    const ClientListScreen = require('point_of_sale.ClientListScreen');

    const podiatry_erp_ClientListScreen = ClientListScreen =>
    ...
    Registries.Component.extend(ClientListScreen,podiatry_erp_ClientListScreen);
});