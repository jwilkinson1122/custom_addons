...
class MedicalPrescription(models.Model):
    ...
    def create(self, vals):
        ...
        result = super(MedicalPrescription, self).create(vals)
        return result

    # def print_prescription_report(self):
    #     return {
    #         'type': 'ir.actions.report',
    #         'report_name': "podiatry_erp.prescription_template",
    #         'report_file': "podiatry_erp.prescription_template",
    ...
    def print_medical_prescription_report_ticket_size(self):
        return self.env.ref("podiatry_erp.medical_prescription_podiatric_ticket_size2").report_action(self)
