...
class Prescription(models.Model):
    ...
    #     return {
    #         'type': 'ir.actions.report',
    #         'report_name': "podiatry_erp.doctor_ophtalmological_prescription_template",
    #         'report_file': "podiatry_erp.doctor_ophtalmological_prescription_template",
    #         'report_type': 'qweb-pdf',
    #     }

    def print_ophtalmologic_prescription_report_ticket_size(self):
        return self.env.ref("podiatry_erp.podiatry_prescription_ophtalmological_ticket_size2").report_action(self)
