...
class Practitioner(models.Model):
    ...
    booking_order_count = fields.Integer(
        string='Booking Orders Count', compute='_compute_booking_order_count')
    ...
    order_date = fields.Datetime(
        'Booking Order Date', default=fields.Datetime.now)
    ...
    other_partner_ids = fields.Many2many(
        ...
        relation='practitioner_partners_rel',
