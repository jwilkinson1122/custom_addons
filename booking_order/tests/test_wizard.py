...
class ConfigurationWizard(ProductConfiguratorTestCases):
    def setUp(self):
        ...
        self.attr_line_fuel = self.env.ref(
            "booking_order.product_attribute_line_2_series_fuel"
        )
        ...
        self.value_218d = self.env.ref(
            "booking_order.product_attribute_value_218d"
        )
        self.value_220d = self.env.ref(
            "booking_order.product_attribute_value_220d"
        )
        ...
        self.config_step_body = self.env.ref("booking_order.config_step_body")
        ...
        self.cfg_tmpl = self.env.ref("booking_order.bmw_2_series")
