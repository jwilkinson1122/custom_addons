...
class TestCommonSalePrescriptionNoChart(TestSaleCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        # Create category
        cls.product_category_prescription = cls.env['product.category'].create({
        ...
        cls.service_prescription_1 = cls.env['product.product'].create({
            ...
            'service_type': 'manual',
            'taxes_id': False,
            'categ_id': cls.product_category_prescription.id,
            'service_to_prescription': True,
            'seller_ids': [Command.set(cls.supplierinfo1.ids)],
        })
        cls.service_prescription_2 = cls.env['product.product'].create({
        ...
        cls.supplierinfo1.product_tmpl_id = cls.service_prescription_1.product_tmpl_id.id
        cls.supplierinfo2.product_tmpl_id = cls.service_prescription_2.product_tmpl_id.id
