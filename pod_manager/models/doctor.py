...
class PodDoctor(models.Model):
    _name = 'podmanager.doctor'
    ...
    view_prescription_ids = fields.One2many('podmanager.prescription', 'appointed_doctor_id', string="Prescription Count",
                                            readonly=True)
