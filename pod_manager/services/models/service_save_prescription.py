        ...
        vals = {
            'arg0': {
                'ereceteDVO': {
                    ...
                    'rushOrder': int(prescription.rush_order),
                    'makeQuantity': int(prescription.make_quantity),
                    'makeFromPriorRx': int(prescription.make_from_prior_rx),
                    'shipToPatient': int(prescription.ship_to_patient),
                    'makeLeftOnly': int(prescription.make_left_only),
                    'makeRightOnly': int(prescription.make_right_only),
