...
#
#
# -*- Orange Prescriptions ile Kaydedilebilen Product List Servisi -*-
#
#
import datetime
...
class TuruncuReceteIlacListesiSorgula(models.Model):
    ...
    _description = "turuncu Prescriptions İle Kaydedilebilen Product List Servisi"
    ...
    def turuncu_ilac_listesi_sorgula(self):
        ...
        with client.settings(strict=False):
            ilac_listesi = client.service.turuncuReceteIlacListesiSorgula(
                **vals)
