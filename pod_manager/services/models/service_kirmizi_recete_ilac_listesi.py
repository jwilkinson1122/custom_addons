...
#
#
# -*- Red Prescriptions ile Kaydedilebilen Product List Servisi -*-
#
#
import datetime
...
class KirmiziReceteIlacListesiSorgula(models.Model):
    ...
    _description = "kirmizi Prescriptions İle Kaydedilebilen Product List Servisi"
    ...
    def kirmizi_ilac_listesi_sorgula(self):
        ...
        with client.settings(strict=False):
            ilac_listesi = client.service.kirmiziReceteIlacListesiSorgula(
                **vals)
