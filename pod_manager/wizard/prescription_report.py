...
class PrescriptionReportWizard(models.TransientModel):
    _name = "pod.manager.prescription.report.wizard"
    ...
    patient_id = fields.Many2one(
        'pod.manager.patient', string="Patient", required=True)
    ...
    def action_print_report(self):
        ...
        prescriptions = self.env['pod.manager.prescription'].search_read(
            domain)
