...
class create_rx_invoice(models.TransientModel):
    ...
    def create_rx_invoice(self):
        ...
        for lab_req in lab_reqs:
            if len(lab_req.rx_line_ids) < 1:
                raise Warning('At least one rx line is required.')
            ...
            list_of_vals = []
            for p_line in lab_req.rx_line_ids:
