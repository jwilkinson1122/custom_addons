...
class PodiatryDoctor(models.Model):
    ...
    job_position = fields.Char(
        string="Designation", help="To add the job position of the doctor"
    )
    ...
    dob = fields.Date(string="Date of Birth", required=True, help="DOB of the patient")
    ...
    time_shift_ids = fields.Many2many(
        "podiatry.time.shift", string="Time Shift", help="Time shift of the doctor"
    )
    ...
    def unlink(self):
        ...
        res = super(PodiatryDoctor, self).unlink()
        return res
