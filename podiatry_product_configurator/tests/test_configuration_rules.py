...
class ConfigurationRules(TransactionCase):
    ...
    def get_attr_val_ids(self, ext_ids):
        ...
        attr_val_prefix = "podiatry_product_configurator.product_attribute_value_%s"
    ...
    def test_invalid_custom_value_configuration(self):
        ...
        attr_color_id = self.env.ref("podiatry_product_configurator.product_attribute_color")
