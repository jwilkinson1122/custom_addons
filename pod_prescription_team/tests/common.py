...
class PrescriptionTeamCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.group_prescription_personnel = cls.env.ref('pod_prescription_team.group_prescription_personnel')
        cls.group_prescription_manager = cls.env.ref('pod_prescription_team.group_prescription_manager')
...
class TestPrescriptionCommon(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.env['ir.config_parameter'].set_param('pod_prescription_team.membership_multi', False)
        ...
        cls.user_prescription_manager = mail_new_test_user(
            ...
            groups='pod_prescription_team.group_prescription_manager,base.group_partner_manager',
        )
        ...
        cls.user_prescription_personnel = mail_new_test_user(
            cls.env, login='user_prescription_personnel',
            name='Orteil Prescription Own', email='crm_personnel@test.example.com',
            company_id=cls.company_main.id,
            notification_type='inbox',
            groups='pod_prescription_team.group_prescription_personnel',
        )
