...
class ResPartner(models.Model):
   ...
   # Identifier Booleans
    ...
    def _check_pod(self, mode="write"):
        ...
        checks = [
            (self.is_pod, self._check_pod_user, "pod_erp_base.group_user"),
            (self.is_company, self._check_pod_account, "pod_erp_base.group_configurator"),
            (self.is_location, self._check_pod_location, "pod_erp_base.group_configurator"),
            (self.is_practitioner, self._check_pod_practitioner, "pod_erp_base.group_configurator")
            (self.is_patient, self._check_pod_patient, "pod_erp_base.group_configurator")
        ]
    ...
    def _check_pod_user(self):
        return self.env.user.has_group("pod_erp_base.group_user")
        
    def _check_pod_account(self):
        return self.env.user.has_group("pod_erp_base.group_configurator")
