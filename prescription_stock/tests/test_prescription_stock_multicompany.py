...
class TestPrescriptionStockMultiCompany(TestPrescriptionCommon, ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.env.user.groups_id |= cls.env.ref('prescription_team.group_prescription_personnel')
    ...
    def test_warehouse_definition_on_so(self):
        ...
        so_no_user = prescription.create(prescription_vals)
        ...
        so_company_A = prescription.with_company(self.env.company).create(prescription_vals2)
        ...
        so_company_B = prescription.with_company(self.company_data_2['company']).create(prescription_vals3)
