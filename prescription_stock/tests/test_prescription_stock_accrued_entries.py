...
class TestAccruedStockPrescriptions(AccountTestInvoicingCommon):
    ...
    def test_prescription_stock_accruals(self):
        ...
        pick = self.prescription.picking_ids
        ...
        wizard = self.env['account.accrued.orders.wizard'].with_context({
            ...
            'active_ids': self.prescription.ids,
        }).create({
    ...
    def test_prescription_stock_invoiced_accrued_entries(self):
        ...
        inv = self.prescription._create_invoices()
