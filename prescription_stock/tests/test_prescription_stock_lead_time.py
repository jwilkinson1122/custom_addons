...
class TestPrescriptionStockLeadTime(TestPrescriptionCommon, ValuationReconciliationTestCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.test_product_order.prescription_delay = 5.0
    ...
    def test_01_product_route_level_delays(self):
        ...
        out_date = fields.Datetime.from_string(order.date_order) + timedelta(days=self.test_product_order.prescription_delay) - timedelta(days=out.move_ids[0].rule_id.delay)
    ...
    def test_02_delivery_date_propagation(self):
        ...
        out = order.picking_ids.filtered(lambda r: r.picking_type_id == self.company_data['default_warehouse'].out_type_id)
        deadline_date = order.date_order + timedelta(days=self.test_product_order.prescription_delay) - timedelta(days=out.move_ids[0].rule_id.delay)
