...
class TestPrescriptionStockReports(TestReportsCommon):
    def test_report_forecast_1_prescription_replenishment(self):
...
class TestPrescriptionStockInvoices(TestPrescriptionCommon):

    def setUp(self):
        super(TestPrescriptionStockInvoices, self).setUp()
