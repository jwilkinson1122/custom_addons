...
import { ProductCatalogPrescriptionLine } from "./prescription_line/prescription_line";
import { patch } from "@web/core/utils/patch";

patch(ProductCatalogKanbanRecord.prototype, {
    updateQuantity(quantity) {
        if (this.env.orderResModel !== "prescription") {
    ...
    get orderLineComponent() {
        if (this.env.orderResModel === "prescription") {
            return ProductCatalogPrescriptionLine;
        }
