...
class AccountMove(models.Model):
    ...
    def _compute_delivery_date(self):
        ...
        for move in self:
            prescription_effective_date = list(filter(None, move.line_ids.prescription_line_ids.order_id.mapped('effective_date')))
            effective_date_res = max(prescription_effective_date) if prescription_effective_date else False
