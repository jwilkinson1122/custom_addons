...
class PrescriptionLine(models.Model):
    ...
    def _compute_qty_delivered_method(self):
        ...
        """
        super(PrescriptionLine, self)._compute_qty_delivered_method()
    ...
    def _compute_qty_delivered(self):
        super(PrescriptionLine, self)._compute_qty_delivered()
    ...
    def create(self, vals_list):
        lines = super(PrescriptionLine, self).create(vals_list)
        lines.filtered(lambda line: line.state == 'prescription')._action_launch_stock_rule()
        return lines

    def write(self, values):
        lines = self.env['prescription.line']
        ...
        res = super(PrescriptionLine, self).write(values)
        if lines:
    ...
    def _compute_customer_lead(self):
        ...
        for line in self:
            line.customer_lead = line.product_id.prescription_delay
    ...
    def _prepare_procurement_values(self, group_id=False):
        ...
        """
        values = super(PrescriptionLine, self)._prepare_procurement_values(group_id)
        self.ensure_one()
        ...
        values.update({
            ...
            'product_description_variants': self.with_context(lang=self.order_id.partner_id.lang)._get_prescription_line_multiline_description_variants(),
    ...
    def _update_line_quantity(self, values):
        ...
        super(PrescriptionLine, self)._update_line_quantity(values)
