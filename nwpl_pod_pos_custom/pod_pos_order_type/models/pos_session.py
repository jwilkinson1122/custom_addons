...
class PosSession(models.Model):
    ...
    def _pos_ui_models_to_load(self):
        ...
        result.append('pod.order.type')
        return result
    def _loader_params_pod_order_type(self):
    ...
    def _get_pos_ui_pod_order_type(self, params):
        return self.env['pod.order.type'].search_read(**params['search_params'])
