...
patch(Order.prototype, {
  export_for_printing() {
    ...
    // Create qr code 
    if (this.pos.config.pod_pos_receipt_bacode_qr && this.pos.config.pod_pos_receipt_barcode_qr_selection == 'qr'  ) {
      ...
      receipt.pod_link_qr_code = "data:image/svg+xml;base64," + window.btoa(qr_code_svg);
    }
    // [create barcode]
    ...
    receipt.pod_order_barcode = createElement.src
    return receipt;
  },
});
...
patch(PosStore.prototype, {
  getReceiptHeaderData() {
    ...
    data['pod_created_seq'] = this.get_order().pod_created_seq || false
    return data
  }
})