...
patch(PosStore.prototype, {
    ...
    async _processData(loadedData) {
        ...
        this.pos_theme_settings_data = loadedData['pod.pos.theme.settings'] || [];
    ...
    async setup(env, { popup, orm, number_buffer, hardware_proxy, barcode_reader, ui }) {
        ...
        if(this.pos_theme_settings_data && this.pos_theme_settings_data[0] && this.pos_theme_settings_data[0].pod_mobile_start_screen && this.pos_theme_settings_data[0].pod_mobile_start_screen == 'cart_screen'){
